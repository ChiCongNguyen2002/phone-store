/* 
 CanvasJS Chart - v3.7.27 GA - https://canvasjs.com/ 
...
(function() {
    ...
    function Xa(h, n, E) {
        "millisecond" === E ? h.setMilliseconds(h.getMilliseconds() + 1 * n) : "second" === E ? h.setSeconds(h.getSeconds() + 1 * n) : "minute" === E ? h.setMinutes(h.getMinutes() + 1 * n) : "hour" === E ? h.setHours(h.getHours() + 1 * n) : "day" === E ? h.setDate(h.getDate() + 1 * n) : "week" === E ? h.setDate(h.getDate() + 7 * n) : "month" === E ? h.setMonth(h.getMonth() + 1 * n) : "year" === E && h.setFullYear(h.getFullYear() +
            1 * n);
        return h
    }
    ...
    function fb(h) {
        if (va.fSDec) h[ia("`eeDwdouMhrudods")](ia("e`u`@ohl`uhnoHuds`uhnoDoe"), function() {
            va._fTWm && va._fTWm(h)
        })
    }
    ...
    function P(h, n, E, w, ha) {
        ...
        w.push([h, n, E, ha]);
        return h.addEventListener ? (h.addEventListener(n, E, ha), E) : h.attachEvent ? (w = function(n) {
            n = n || window.event;
    ...
    function hb(h) {
        if (h._menuButton) h.exportEnabled ? (V(h._menuButton, {
            backgroundColor: h.toolbar.itemBackgroundColor,
            color: h.toolbar.fontColor
        }), Ma(h._menuButton), sa(h, h._menuButton, "menu")) : wa(h._menuButton);
            ...
            P(h._menuButton, "touchstart", function(h) {
                n = !0
            ...
            P(h._menuButton, "mousemove", function() {
                ...
                }), 0 >= navigator.userAgent.search("MSIE") && V(h._menuButton.childNodes[0], {
        ...
        if (h.exportEnabled && h._dropdownMenu) {
            ...
            for (var E = h._dropdownMenu.childNodes, s = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText],
                    ha = 0; ha < E.length; ha++) V(E[ha], {
                backgroundColor: h.toolbar.itemBackgroundColor,
                color: h.toolbar.fontColor
            }), E[ha].innerHTML = s[ha]
        } else !h._dropdownMenu && (h.exportEnabled && w) && (n = !1, h._dropdownMenu = document.createElement("div"), h._dropdownMenu.setAttribute("tabindex", -1), E = -1 !== h.theme.indexOf("dark") ? "black" : "#888888", V(h._dropdownMenu, {
                position: "absolute",
                zIndex: 1,
                userSelect: "none",
                MozUserSeelct: "none",
            ...
            }, h.allDOMEventHandlers, !0), E = document.createElement("div"), V(E, {
                padding: "12px 8px 12px 8px"
            }), E.innerHTML = h._cultureInfo.printText, E.style.backgroundColor =
            h.toolbar.itemBackgroundColor, E.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(E), P(E, "touchstart", function(h) {
                n = !0
            ...
            }, h.allDOMEventHandlers, !0), P(E, "mouseout", function() {
                ...
                padding: "12px 8px 12px 8px"
            }), E.innerHTML = h._cultureInfo.saveJPGText, E.style.backgroundColor = h.toolbar.itemBackgroundColor, E.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(E), P(E, "touchstart", function(h) {
                n = !0
            }, h.allDOMEventHandlers), P(E, "mousemove", function() {
                n || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover)
            }, h.allDOMEventHandlers, !0), P(E,
                "mouseout",
                function() {
                    n || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor)
                }, h.allDOMEventHandlers, !0), P(E, "click", function() {
                ...
                padding: "12px 8px 12px 8px"
            }), E.innerHTML = h._cultureInfo.savePNGText, E.style.backgroundColor = h.toolbar.itemBackgroundColor, E.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(E), P(E,
                "touchstart",
                function(h) {
                    n = !0
                }, h.allDOMEventHandlers), P(E, "mousemove", function() {
    ...
    function Na(h, n, E, xa) {
        w && ab ? (xa = !s(xa) && xa ? h.getContext("2d", {
                willReadFrequently: !0
            }) : h.getContext("2d"), Oa = xa.webkitBackingStorePixelRatio || xa.mozBackingStorePixelRatio || xa.msBackingStorePixelRatio || xa.oBackingStorePixelRatio || xa.backingStorePixelRatio || 1, la = Sa / Oa, h.width = n * la, h.height = E * la, Sa !==
    ...
    function ib(h) {
        if (!jb) {
            ...
            if (h.creditHref && h.creditText) {
                ...
                if (0 === h.renderCount || n || E) h._creditLink.setAttribute("href", h.creditHref), h._creditLink.innerHTML = h.creditText;
                h._creditLink && h.creditHref && h.creditText ? (h._creditLink.parentElement ||
    ...
    function ua(h, n, E) {
        ...
        Na(s, h, n, E);
        w || "undefined" === typeof G_vmlCanvasManager || G_vmlCanvasManager.initElement(s);
        return s
    }
    ...
    function sa(h, n,
        s) {
        n.getAttribute("state") || (n.style.backgroundColor = h.toolbar.itemBackgroundColor, n.style.color = h.toolbar.fontColor, n.style.border = "none", V(n, {
            WebkitUserSelect: "none",
            MozUserSelect: "none",
            msUserSelect: "none",
            userSelect: "none"
        }));
        n.getAttribute("state") !== s && (n.setAttribute("state", s), n.setAttribute("type", "button"), V(n, {
                padding: "5px 12px",
                cursor: "pointer",
                "float": "left",
                width: "40px",
                ...
                lineHeight: "0"
            }), n.innerHTML = "<img src='" + kb[s].image + "' alt='" +
            h._cultureInfo[s + "Text"] + "' />", V(n.childNodes[0], {
                height: "95%",
                pointerEvents: "none"
            }));
    ...
    function Ma() {
        for (var h = null, n = 0; n < arguments.length; n++) h = arguments[n], h.style && (h.style.display = "inline")
    }

    function wa() {
        for (var h = null, n = 0; n < arguments.length; n++)(h = arguments[n]) && h.style && (h.style.display = "none")
    }

    function Ta(h, n, s, w, ha) {
        if (null === h || "undefined" === typeof h) return "undefined" === typeof s ? n : s;
        h = parseFloat(h.toString()) * (0 <= h.toString().indexOf("%") ?
            n / 100 : 1);
        "undefined" !== typeof w && (h = Math.min(w, h), "undefined" !== typeof ha && (h = Math.max(ha, h)));
    ...
    function G(h, n, E, w, ha) {
        ...
        h = {};
        this.theme && s(this.parent) && s(n) && s(w) ? h = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[n]) && (null === w ? h = this.parent.themeOptions[n] :
            0 < this.parent.themeOptions[n].length && (w = Math.min(this.parent.themeOptions[n].length - 1, w), h = this.parent.themeOptions[n][w]));
        this.themeOptions = h;
        this.options = E ? E : {
            _isPlaceholder: !0
        };
    ...
    function za(h, n) {
        ...
        if (s(this.options.margin) && h.options.subtitles)
            for (var E = h.options.subtitles, w = 0; w < E.length; w++)
                if ((s(E[w].horizontalAlign) &&
                        "center" === this.horizontalAlign || E[w].horizontalAlign === this.horizontalAlign) && (s(E[w].verticalAlign) && "top" === this.verticalAlign || E[w].verticalAlign === this.verticalAlign) && !E[w].dockInsidePlotArea === !this.dockInsidePlotArea) {
                    this.margin = 0;
                    break
                }
    ...
    (function() {
        va.fSDec = function(h) {
            for (var n = "", s = 0; s < h.length; s++) n += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(s));
            return n
        };
        delete pa[va.fSDec("Bi`su")][va.fSDec("bsdehuIsdg")];
        va.pro = {
            sCH: pa[va.fSDec("Bi`su")][va.fSDec("bsdehuIsdg")]
        }
    })();
    var gb = function() {
            var h = !1;
                ...
                return N = J.replace(h, function(l) {
                    switch (l) {
                        ...
                        case "TT":
                            return 12 > d ? "AM" : "PM";
                        case "K":
                            return V ? "UTC" : (String(v).match(B) || [""]).pop().replace(A, "");
                        case "z":
        ...
        nb = function(h) {
            ...
            if (1 > Math.abs(h)) {
                ...
                s && (h = (n ? -1 * h : h) * Math.pow(10, s - 1), h = "0." + Array(s).join("0") + h.toString().substring(2), h = n ? "-" + h : h)
            } else s = parseInt(h.toString().split("+")[1]), 20 < s && (s -= 20, h /= Math.pow(10, s), h = h.toString() + Array(s + 1).join("0"));
            return String(h)
        },
        da = function(h, n, s) {
            if (null === h) return "";
            ...
            for (var M = 0; J && M < J.length; M++)
                if (n = J[M], "." === n && 0 > K) K = M;
                    ...
                    if ("%" === n) A *= 100;
                        ...
                        K = M + n.length - 1;
                        continue
                    } else "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || (G = !0);
                    0 > K ? (N.push(n), "#" === n || "0" === n ? P++ : "," === n && V++) : (X.push(n), "#" !== n && "0" !== n || T++)
                } G && (n = Math.floor(h), J = -Math.floor(Math.log(h) / Math.LN10 +
                1), Q = 0 === h ? 0 : 0 === n ? -(P + J) : nb(n).length - P, A /= Math.pow(10, Q));
            0 > K && (K = M);
            A = (h * A).toFixed(T);
            n = A.split(".");
            A = (n[0] + "").split("");
            ...
            for (G = J = M = T = K = 0; 0 < N.length;)
                if (n = N.pop(), "#" === n || "0" === n)
                    if (K++, K === P) {
                        ...
                        for (; 0 < W.length;) s = W.pop() + s, G++, 0 === G % J && (M === V && 0 < W.length) && (s = v + s)
                    } else 0 < A.length ? (s = A.pop() + s, T++, G++) : "0" === n && (s = "0" + s, T++, G++), 0 === G % J && (M === V && 0 < A.length) && (s = v + s);
            else "E" !==
                n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ? "," === n ? (M++, J = G, G = 0, 0 < A.length && (s = v + s)) : s = 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? n.slice(1, n.length - 1) + s : n + s : (n = 0 > Q ? n.replace("+", "").replace("-", "") : n.replace("-", ""), s += n.replace(/[0]+/, function(a) {
                    return ca(Q, a.length)
                }));
            v = "";
            for (N = !1; 0 < X.length;) n = X.shift(), "#" === n || "0" === n ? 0 < h.length && 0 !== Number(h.join("")) ? (v += h.shift(), N = !0) : "0" === n && (v += "0", N = !0) : 1 < n.length && ('"' === n[0] && '"' === n[n.length -
                1] || "'" === n[0] && "'" === n[n.length - 1]) ? v += n.slice(1, n.length - 1) : "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ? v += n : (n = 0 > Q ? n.replace("+", "").replace("-", "") : n.replace("-", ""), v += n.replace(/[0]+/, function(a) {
                return ca(Q, a.length)
            }));
            s += (N ? B : "") + v;
            return w ? "-" + s : s
        ...
        Pa = function(h) {
            var n = 0,
                s = 0;
            h = h || window.event;
            h.offsetX || 0 === h.offsetX ? (n = h.offsetX, s = h.offsetY) : h.layerX || 0 == h.layerX ? (n = h.layerX, s = h.layerY) : (n = h.pageX - h.target.offsetLeft, s = h.pageY - h.target.offsetTop);
            return {
                x: n,
                y: s
            }
        ...
        Y = function(h, n, s, w, v, B, A, J, K, N, X, T, P) {
            ...
            h.globalAlpha = 1;
            0 < A && (P = 0 === A % 2 ? 0 : 0.5, h.beginPath(), h.lineWidth = A, h.strokeStyle = J, h.moveTo(n, s), h.rect(n - P, s - P, w - n + 2 * P, v - s + 2 * P), h.stroke());
            h.restore();
            !0 === K && (h.save(), h.beginPath(), h.moveTo(n, s), h.lineTo(n + G, s + G), h.lineTo(w -
                G, s + G), h.lineTo(w, s), h.closePath(), A = h.createLinearGradient((w + n) / 2, s + G, (w + n) / 2, s), A.addColorStop(0, B), A.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = A, h.fill(), h.restore());
            !0 === N && (h.save(), h.beginPath(), h.moveTo(n, v), h.lineTo(n + G, v - G), h.lineTo(w - G, v - G), h.lineTo(w, v), h.closePath(), A = h.createLinearGradient((w + n) / 2, v - G, (w + n) / 2, v), A.addColorStop(0, B), A.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = A, h.fill(), h.restore());
            !0 === X && (h.save(), h.beginPath(), h.moveTo(n, s), h.lineTo(n + G, s +
                G), h.lineTo(n + G, v - G), h.lineTo(n, v), h.closePath(), A = h.createLinearGradient(n + G, (v + s) / 2, n, (v + s) / 2), A.addColorStop(0, B), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = A, h.fill(), h.restore());
            !0 === T && (h.save(), h.beginPath(), h.moveTo(w, s), h.lineTo(w - G, s + G), h.lineTo(w - G, v - G), h.lineTo(w, v), A = h.createLinearGradient(w - G, (v + s) / 2, w, (v + s) / 2), A.addColorStop(0, B), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = A, A.addColorStop(0, B), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = A, h.fill(),
                h.closePath(), h.restore())
        },
        ia = function(h) {
            for (var n = "", s = 0; s < h.length; s++) n += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(s));
            return n
        },
        jb = window && (window[ia("mnb`uhno")] && window[ia("mnb`uhno")].href && window[ia("mnb`uhno")].href.indexOf && (-1 !== window[ia("mnb`uhno")].href.indexOf(ia("b`ow`rkr/bnl")) || -1 !== window[ia("mnb`uhno")].href.indexOf(ia("gdonqhy/bnl")) || -1 !== window[ia("mnb`uhno")].href.indexOf(ia("gheemd")))) && -1 === window[ia("mnb`uhno")].href.indexOf(ia("gheemd")),
        kb = {
            reset: {
    ...
    G.prototype.setOptions = function(h, n) {
        if (pa[this._defaultsKey]) {
            var s = pa[this._defaultsKey],
                w;
            for (w in s) "publicProperties" !== w && s.hasOwnProperty(w) && (this[w] = h && w in h ? h[w] : n && w in n ? n[w] : s[w])
    ...
    G.prototype.get = function(h) {
        ...
        if (n.hasOwnProperty(h) || n.publicProperties && n.publicProperties.hasOwnProperty(h)) return this[h];
        window.console &&
    ...
    G.prototype.set = function(h, n, s) {
        ...
        else if (w.hasOwnProperty(h) || w.publicProperties && w.publicProperties.hasOwnProperty(h) && "readWrite" === w.publicProperties[h]) this.options._isPlaceholder && this.createUserOptions(), this.options[h] = n;
        else {
    ...
    G.prototype.createUserOptions = function(h) {
        if ("undefined" !== typeof h || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder &&
                ...
                n[s] = this.options
            } else this.options = "undefined" === typeof h ? {} : h, h = this.parent.options, this.optionsName ? n = this.optionsName : (n = this._defaultsKey) && 0 !== n.length ? (s = n.charAt(0).toLowerCase(), 1 < n.length && (s = s.concat(n.slice(1))),
                n = s) : n = void 0, h[n] = this.options
    };
    ...
    G.prototype.updateOption = function(h) {
        ...
        var n = pa[this._defaultsKey],
            ...
            J = this._index;
        this.theme && s(this.parent) && s(B) && s(J) ? w = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[B]) && (null === J ? w = this.parent.themeOptions[B] : 0 < this.parent.themeOptions[B].length && (w = Math.min(this.parent.themeOptions[B].length - 1, J), w = this.parent.themeOptions[B][w]));
        this.themeOptions = w;
        h in n && (v = h in this.options ? this.options[h] : w && h in w ? w[h] : n[h]);
    ...
    ja.prototype._getLineWithWidth = function(h, n, s) {
        ...
        s > n && 1 < A.length && (A = A.substr(0, A.length - 1), s = this.ctx.measureText(A).width);
        n = !0;
        if (A.length === h.length || " " === h[A.length]) n = !1;
        n && (h = A.split(" "), 1 < h.length && h.pop(), A = h.join(" "), s = this.ctx.measureText(A).width);
        return {
            text: A,
            width: s
        }
    ...
    za.prototype.setLayout = function() {
        if (this.text) {
            ...
            N = J.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (v = n.y1 + 2 + this.fontSize / 2 + 4, K = "top") : "bottom" === this.verticalAlign && (v = n.y2 - 2 - N.height + this.fontSize / 2 + 4, K = "bottom"), "left" === this.horizontalAlign ? w = n.x1 + 2 : "center" === this.horizontalAlign ? w = n.x1 + n.width /
                ...
                (v = h.y1 + (h.height / 2 - N.height / 2) + this.fontSize / 2 + 4, w = h.x1 + (h.width / 2 - N.width / 2), K = "center", this.width = N.width, this.height = N.height), G = "center");
            J.x = w;
            J.y = v;
            J.angle = B;
            J.horizontalAlign = G;
    ...
    Va.prototype.get = function(h, s) {
        var w = null;
        0 < this.pool.length ? (w = this.pool.pop(), Na(w, h, s)) : w = ua(h, s);
        return w
    };
    ...
    "undefined" !== typeof module && "undefined" !== typeof module.exports ? module.exports = Qa : "function" === typeof define && define.amd ? define([], function() {
        return Qa
    }) : (window.CanvasJS && window.console && window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."), window.CanvasJS = window.CanvasJS ? window.CanvasJS :
        Qa);
    B = Qa.Chart = function() {
        function h(a, d) {
            return a.x - d.x
        ...
        function n(a, d, c) {
            ...
            (this.container = "string" ===
                ...
                this.canvas.style.WebkitUserSelect = "none", this.canvas.style.MozUserSelect = "none", this.canvas.style.msUserSelect = "none", this.canvas.style.userSelect = "none", this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Da(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Da(this._preRenderCtx), w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ua(a, d), this.plotArea.canvas.style.position =
                    ...
                    "none", this.overlaidCanvas.getContext && (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline = "top", Da(this.overlaidCanvasCtx)), this._eventManager = new Z(this), this.windowResizeHandler = P(window, "resize", function() {
                        ...
                        b._touchEventHandler(a)
                    }, this.allDOMEventHandlers), this.toolTip = new U(this, this.options.toolTip), this.data = null, this.axisX = [], this.axisX2 = [], this.axisY = [], this.axisY2 = [], this.sessionVariables = {
                        axisX: [],
                        axisX2: [],
                        axisY: [],
                        axisY2: []
        ...
        function v(a, d) {
            for (var c = [], b, e = 0; e < a.length; e++)
                if (0 == e) c.push(a[0]);
                    ...
                    var C = (a[l].x - a[f].x) / b;
                    b = (a[l].y - a[f].y) / b;
                    c[c.length] = a[t].x > a[f].x && 0 < C || a[t].x < a[f].x && 0 > C ? {
                        x: a[t].x + C / 3,
                        y: a[t].y + b / 3
                    } : {
                        x: a[t].x,
        ...
        function B(a, d, c, b, e, f, l, t, C, k) {
            ...
            a.setLineDash && a.setLineDash(J(t.dashType,
                t.thickness));
            a.beginPath();
            ...
            a.beginPath();
            C && 0 < l.thickness ? (a.moveTo(b - m, c), a.lineTo(b - m, e), a.moveTo(d + m, c), a.lineTo(d + m, e)) : 0 < l.thickness && (a.moveTo(d, c +
                m), a.lineTo(b, c + m), a.moveTo(d, e - m), a.lineTo(b, e - m));
            a.stroke();
            a.restore()
        }
        ...
        function A(a, d, c, b, e, f) {
            ...
            this.isOptionsInArray = !0;
            "axisX" === e ? ("left" === f || "bottom" === f ? (this.optionsName = "axisX", s(this.chart.sessionVariables.axisX[b]) && (this.chart.sessionVariables.axisX[b] = {}), this.sessionVariables = this.chart.sessionVariables.axisX[b]) : (this.optionsName = "axisX2", s(this.chart.sessionVariables.axisX2[b]) &&
            ...
            this.options.scaleBreaks && (this.scaleBreaks = new fa(this.chart, this.options.scaleBreaks, ++this.chart._eventManager.lastObjectId, this));
            this.stripLines = [];
            ...
            this.options.crosshair && (this.crosshair = new ca(this.chart,
        ...
        function aa(a, d, c, b, e, f) {
            ...
            this.lineDashType =
                c.lineDashType ? this.lineDashType : f.lineDashType;
            ...
            "string" === typeof this.options.spacing ? (this.spacing =
                parseFloat(this.spacing), this.spacing = isNaN(this.spacing) ? 0 : (10 < this.spacing ? 10 : this.spacing) + "%") : "number" !== typeof this.options.spacing && (this.spacing = f.spacing);
        ...
        n.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton) V(this._zoomButton, {
                    ...
                    P(this._zoomButton, "click", function() {
                        a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, sa(a, a._zoomButton, "zoom")) :
                            (a.zoomEnabled = !0, a.panEnabled = !1, sa(a, a._zoomButton, "pan"));
                        a.render()
                    }, this.allDOMEventHandlers);
                    P(this._zoomButton, "mousemove", function() {
                        d ? d = !1 : (V(a._zoomButton, {
                            backgroundColor: a.toolbar.itemBackgroundColorOnHover,
                            color: a.toolbar.fontColorOnHover,
                            transition: "0.4s",
                            WebkitTransition: "0.4s"
                        }), 0 >= navigator.userAgent.search("MSIE") && V(a._zoomButton.childNodes[0], {
                            WebkitFilter: "invert(100%)",
                            filter: "invert(100%)"
                        }))
                    }, this.allDOMEventHandlers);
                ...
                this._resetButton ? (V(this._resetButton, {
                        borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor,
                        backgroundColor: a.toolbar.itemBackgroundColor,
                        color: a.toolbar.fontColor
                    ...
                    (d = !1, wa(this._resetButton = document.createElement("button")), sa(this, this._resetButton, "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.buttonBorderThickness : 0) + "px solid " + this.toolbar.buttonBorderColor, this._toolBar.appendChild(this._resetButton), P(this._resetButton, "touchstart", function(a) {
                        ...
                        0 >= navigator.userAgent.search("MSIE") && V(a._resetButton.childNodes[0], {
                            WebkitFilter: "invert(0%)",
                            filter: "invert(0%)"
                        });
                    ...
                    }, this.allDOMEventHandlers), P(this._resetButton, "mousemove", function() {
                            d || (V(a._resetButton, {
                                backgroundColor: a.toolbar.itemBackgroundColorOnHover,
                                color: a.toolbar.fontColorOnHover,
                                transition: "0.4s",
                ...
                this.zoomEnabled || this.panEnabled || (this._zoomButton ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ?
                    (this.panEnabled = !0, this.zoomEnabled = !1) : (this.zoomEnabled = !0, this.panEnabled = !1), Ma(a._zoomButton, a._resetButton)) : (this.zoomEnabled = !0, this.panEnabled = !1))
                ...
                for (var c = 0; c < this.options.data.length; c++)
                    if (a++, !this.options.data[c].type || 0 <= n._supportedChartTypes.indexOf(this.options.data[c].type)) {
                        ...
                        "bubble" !== b.type && "scatter" !==
                            b.type || !b.dataPoints || (b.dataPoints.some ? b.dataPoints.some(function(a) {
                                return a.x
        ...
        n.prototype.setLayout = function() {
                    ...
                    if (!this.data[d].axisYType || "primary" === this.data[d].axisYType)
                        if (this.options.axisY && 0 < this.options.axisY.length) {
                            if (!this.axisY.length)
                                for (var c = 0; c < this.options.axisY.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[c] = new A(this, "axisY", this.options.axisY[c], c, "axisY", "left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[c] = new A(this, "axisY", this.options.axisY[c], c, "axisY",
                                    "bottom"));
                        ...
                        } else this.axisY.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[0] = new A(this, "axisY", this.options.axisY, 0, "axisY", "left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[0] = new A(this,
                    ...
                    if ("secondary" === this.data[d].axisYType)
                        if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                            if (!this.axisY2.length)
                                for (c = 0; c < this.options.axisY2.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[c] = new A(this, "axisY2", this.options.axisY2[c], c, "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[c] = new A(this,
                        ...
                        } else this.axisY2.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[0] = new A(this, "axisY2", this.options.axisY2, 0, "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement &&
                            this._axes.push(this.axisY2[0] = new A(this, "axisY2", this.options.axisY2, 0, "axisY", "top"))), this.data[d].axisY = this.axisY2[0], this.axisY2[0].dataSeries.push(this.data[d]);
                    if (!this.data[d].axisXType || "primary" === this.data[d].axisXType)
                        if (this.options.axisX && 0 < this.options.axisX.length) {
                            if (!this.axisX.length)
                                for (c = 0; c < this.options.axisX.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[c] = new A(this, "axisX", this.options.axisX[c], c, "axisX", "bottom")) : "xySwapped" === this.plotInfo.axisPlacement &&
                                    this._axes.push(this.axisX[c] = new A(this, "axisX", this.options.axisX[c], c, "axisX", "left"));
                        ...
                        } else this.axisX.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[0] = new A(this, "axisX", this.options.axisX, 0, "axisX", "bottom")) :
                            "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[0] = new A(this, "axisX", this.options.axisX, 0, "axisX", "left"))), this.data[d].axisX = this.axisX[0], this.axisX[0].dataSeries.push(this.data[d]);
                    if ("secondary" === this.data[d].axisXType)
                        if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                            if (!this.axisX2.length)
                                for (c = 0; c < this.options.axisX2.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[c] = new A(this, "axisX2", this.options.axisX2[c], c, "axisX", "top")) : "xySwapped" ===
                                    this.plotInfo.axisPlacement && this._axes.push(this.axisX2[c] = new A(this, "axisX2", this.options.axisX2[c], c, "axisX", "right"));
                        ...
                        } else this.axisX2.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[0] = new A(this, "axisX2",
                            this.options.axisX2, 0, "axisX", "top")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[0] = new A(this, "axisX2", this.options.axisX2, 0, "axisX", "right"))), this.data[d].axisX = this.axisX2[0], this.axisX2[0].dataSeries.push(this.data[d])
                } if (this.axisY) {
            ...
            if (0 < this._axes.length && this.options.zoomEnabled && (this.zoomEnabled || this.panEnabled))
                for (d = 0; d < this._axes.length; d++)
                    if (!s(this._axes[d].viewportMinimum) || !s(this._axes[d].viewportMaximum)) {
                        c = !0;
                        break
                    } c ? (Ma(this._zoomButton, this._resetButton), this._toolBar.style.border = this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, this._zoomButton.style.borderRight =
            ...
            fb(this);
            this._processData();
            this.options.title && (this.title = new za(this, this.options.title),
                this.title.dockInsidePlotArea ? a.push(this.title) : this.title.setLayout());
            if (this.options.subtitles)
                for (d = 0; d < this.options.subtitles.length; d++) c = new Ja(this, this.options.subtitles[d], d), this.subtitles.push(c), c.dockInsidePlotArea ? a.push(c) : c.setLayout();
            ...
            for (d = 0; d < this._axes.length; d++)
                if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) {
                    w ? (this._breaksCanvas = ua(this.width, this.height, !0), this._breaksCanvasCtx = this._breaksCanvas.getContext("2d")) : (this._breaksCanvas = this.canvas, this._breaksCanvasCtx = this.ctx);
                    break
                } this._preRenderCanvas = ua(this.width, this.height);
            this._preRenderCtx = this._preRenderCanvas.getContext("2d");
            "normal" !== this.plotInfo.axisPlacement &&
                "xySwapped" !== this.plotInfo.axisPlacement || A.setLayout(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement, this.layoutManager.getFreeSpace())
        };
        n.prototype.renderElements = function() {
            if (this.height) {
                ...
                if ("normal" === this.plotInfo.axisPlacement ||
                    "xySwapped" === this.plotInfo.axisPlacement) A.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement);
                ...
                w && this._breaksCanvas && (this._preRenderCtx.drawImage(this.canvas,
                ...
                for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                    for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
                        ...
                        t.targetCanvas = null;
                        this.animatedRender &&
                            (t.targetCanvas = ua(this.width, this.height), t.targetCanvasCtx = t.targetCanvas.getContext("2d"), e = t.targetCanvasCtx.miterLimit, t.targetCanvasCtx.miterLimit = 3);
                        "line" === t.type ? C = this.renderLine(t) : "stepLine" === t.type ? C = this.renderStepLine(t) : "spline" === t.type ? C = this.renderSpline(t) : "column" === t.type ? C = this.renderColumn(t) : "bar" === t.type ? C = this.renderBar(t) : "area" === t.type ? C = this.renderArea(t) : "stepArea" === t.type ? C = this.renderStepArea(t) : "splineArea" === t.type ? C = this.renderSplineArea(t) : "stackedColumn" ===
                ...
                var m = this;
                if (0 < c.length) m.disableToolTip = !0, m._animator.animate(200,
                    m.animationDuration,
                    function(a) {
                        m.ctx.clearRect(0, 0, m.width, m.height);
                        m.ctx.drawImage(b, 0, 0, Math.floor(m.width * la), Math.floor(m.height * la), 0, 0, m.width, m.height);
                        for (var e = 0; e < c.length; e++) C = c[e], 1 > a && "undefined" !== typeof C.startTimePercent ? a >= C.startTimePercent && C.animationCallback(C.easingFunction(a - C.startTimePercent, 0, 1, 1 - C.startTimePercent), C) : C.animationCallback(C.easingFunction(a, 0, 1, 1), C);
                    ...
                    function() {
                        ...
                        for (var a = 0; a < m.plotInfo.plotTypes.length; a++)
                            for (var e =
                                    m.plotInfo.plotTypes[a], d = 0; d < e.plotUnits.length; d++) {
                                var f = e.plotUnits[d];
                    ...
                    if (m._breaksCanvas)
                        if (w) m.plotArea.ctx.drawImage(m._breaksCanvas, 0, 0, this.width, this.height);
                            ...
                            for (k = 0; k < m._axes.length; k++) m._axes[k].createMask();
            ...
            for (var a =
                ...
                if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= n._supportedChartTypes.indexOf(a.type)) {
                    ...
                    for (l = 0; l < c.plotUnits.length; l++)
                        if (c.plotUnits[l].axisYType === a.axisYType && c.plotUnits[l].axisXType === a.axisXType &&
                            c.plotUnits[l].axisYIndex === a.axisYIndex && c.plotUnits[l].axisXIndex === a.axisXIndex) {
                            f = !0;
                            e = c.plotUnits[l];
                            break
                        } f || (e = {
        ...
        n.prototype._processData = function() {
            ...
            for (var a = 0; a < this.plotInfo.plotTypes.length; a++)
                for (var d = this.plotInfo.plotTypes[a], c = 0; c < d.plotUnits.length; c++) {
                    var b = d.plotUnits[c];
                    "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" ===
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var t = this.data[a.dataSeriesIndexes[l]],
                        ...
                        m = !1,
                        p;
                    if ("normal" === t.axisPlacement || "xySwapped" === t.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options &&
                        a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : a.axisX.logarithmic ? 0 : -Infinity,
                    ...
                    if (t.dataPoints[C].x && t.dataPoints[C].x.getTime || "dateTime" === t.xValueType) f = !0;
                    for (C = 0; C < t.dataPoints.length; C++) {
                        "undefined" ===
                        typeof t.dataPoints[C].x && (t.dataPoints[C].x = C + (a.axisX.logarithmic ? 1 : 0));
                        t.dataPoints[C].x.getTime ? (f = !0, b = t.dataPoints[C].x.getTime()) : b = t.dataPoints[C].x;
                        e = t.dataPoints[C].y;
                        b < c.min && (c.min = b);
                        b > c.max && (c.max = b);
                        ...
                        if (0 < C) {
                            ...
                            } else r = b - t.dataPoints[C - 1].x, 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r);
                            null !== e && null !== t.dataPoints[C -
                                1].y && (a.axisY.logarithmic ? (r = e / t.dataPoints[C - 1].y, 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e - t.dataPoints[C - 1].y, 0 > r && (r *= -1), d.minDiff > r && 0 !== r && (d.minDiff = r)))
                        }
                        if (b < q && !k) null !== e && (p = b);
                        else {
                            if (!k && (k = !0, 0 < C)) {
                            ...
                            null === e ? c.viewPortMin === b && p < b && (c.viewPortMin = p) : (e < d.viewPortMin && "number" === typeof e &&
                                (d.viewPortMin = e), e > d.viewPortMax && "number" === typeof e && (d.viewPortMax = e))
                        }
                    }
        ...
        n.prototype._processStackedPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], t = [], C = Infinity, k = -Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var p = this.data[a.dataSeriesIndexes[m]],
                        q = 0,
                        g = !1,
                        r = !1,
                        h;
                    if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement) var ba = a.axisX.sessionVariables.newViewportMinimum ?
                        a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : -Infinity,
                        u = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : a.axisX.options && a.axisX.options.viewportMaximum ? a.axisX.options.viewportMaximum : a.axisX.options && a.axisX.options.maximum ? a.axisX.options.maximum : Infinity;
                    if (p.dataPoints[q].x && p.dataPoints[q].x.getTime || "dateTime" ===
                        p.xValueType) f = !0;
                    for (q = 0; q < p.dataPoints.length; q++) {
                        ...
                        if (0 < q) {
                            ...
                            null !== e && null !==
                                p.dataPoints[q - 1].y && (a.axisY.logarithmic ? 0 < e && (y = e / p.dataPoints[q - 1].y, 1 > y && (y = 1 / y), d.minDiff > y && 1 !== y && (d.minDiff = y)) : (y = e - p.dataPoints[q - 1].y, 0 > y && (y *= -1), d.minDiff > y && 0 !== y && (d.minDiff = y)))
                        }
                        if (b < ba && !g) null !== p.dataPoints[q].y && (h = b);
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === p.dataPoints[q].y ? c.viewPortMin === b && h < b && (c.viewPortMin =
                                h) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l[b] ? l[b] += e : (l[b] = e, C = Math.min(e, C)) : t[b] ? t[b] += e : (t[b] = e, k = Math.max(e, k)))
                        }
                    }
                    a.axisY.scaleBreaks && (a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks) && (d.dataPointYPositiveSums ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, l), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, t)) : (d.dataPointYPositiveSums = l, d.dataPointYNegativeSums =
                        t));
                    p.axisX.valueType = p.xValueType = f ? "dateTime" : "number"
                }
                for (q in l) l.hasOwnProperty(q) && !isNaN(q) && (a = l[q], a < d.min && (d.min = Math.min(a, C)), a > d.max && (d.max = a), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, C)), a > d.viewPortMax && (d.viewPortMax = a)));
        ...
        n.prototype._processStacked100PlotUnit =
            function(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, t = !1, C = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                        var m = this.data[a.dataSeriesIndexes[k]],
                            p = 0,
                            q = !1,
                            g = !1,
                            r;
                        if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var h = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ?
                            a.axisX.options.minimum : -Infinity,
                            ba = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : a.axisX.options && a.axisX.options.viewportMaximum ? a.axisX.options.viewportMaximum : a.axisX.options && a.axisX.options.maximum ? a.axisX.options.maximum : Infinity;
                        if (m.dataPoints[p].x && m.dataPoints[p].x.getTime || "dateTime" === m.xValueType) f = !0;
                        for (p = 0; p < m.dataPoints.length; p++) {
                            ...
                            m.dataPoints[p].x.getTime ?
                                (f = !0, b = m.dataPoints[p].x.getTime()) : b = m.dataPoints[p].x;
                            ...
                            if (0 < p) {
                                ...
                                } else u = b - m.dataPoints[p - 1].x, 0 > u && (u *= -1), c.minDiff > u && 0 !== u && (c.minDiff = u);
                                s(e) || null === m.dataPoints[p - 1].y || (a.axisY.logarithmic ? 0 < e && (u = e / m.dataPoints[p - 1].y, 1 > u && (u = 1 / u), d.minDiff > u && 1 !== u && (d.minDiff = u)) : (u = e - m.dataPoints[p - 1].y, 0 > u && (u *= -1), d.minDiff >
                                    u && 0 !== u && (d.minDiff = u)))
                            }
                            if (b < h && !q) null !== e && (r = b);
                            else {
                                ...
                                b < c.viewPortMin && (c.viewPortMin = b);
                                b > c.viewPortMax && (c.viewPortMax = b);
                                null === e ? c.viewPortMin === b && r < b && (c.viewPortMin = r) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l = !0 : 0 > e && (t = !0), C[b] = C[b] ? C[b] + Math.abs(e) : Math.abs(e))
                            }
                        }
                        m.axisX.valueType =
                            m.xValueType = f ? "dateTime" : "number"
                    }
                    a.axisY.logarithmic ? (d.max = s(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && !t ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && t ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !l && t && (d.max = s(d.viewPortMax) ? -1 : Math.max(d.viewPortMax,
                        -1), d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99));
                    d.viewPortMin = d.min;
                    d.viewPortMax = d.max;
                    a.dataPointYSums = C
                }
        ...
        n.prototype._processMultiYPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, t = !1, C = 0; C < a.dataSeriesIndexes.length; C++) {
                    var k = this.data[a.dataSeriesIndexes[C]],
                        m = 0,
                        p = !1,
                        q = !1,
                        g, r, h;
                    if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement) var s = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum :
                        a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : a.axisX.logarithmic ? 0 : -Infinity,
                        u = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : a.axisX.options && a.axisX.options.viewportMaximum ? a.axisX.options.viewportMaximum : a.axisX.options && a.axisX.options.maximum ? a.axisX.options.maximum : Infinity;
                    ...
                    for (m = 0; m < k.dataPoints.length; m++) {
                        ...
                        k.dataPoints[m].x.getTime ? (t = !0, b = k.dataPoints[m].x.getTime()) : b = k.dataPoints[m].x;
                        ...
                        f < d.min && (d.min = f);
                        l > d.max && (d.max = l);
                        0 < m && (a.axisX.logarithmic ? (r = b / k.dataPoints[m - 1].x, 1 > r && (r = 1 / r),
                            c.minDiff > r && 1 !== r && (c.minDiff = r)) : (r = b - k.dataPoints[m - 1].x, 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r)), e && (null !== e[0] && k.dataPoints[m - 1].y && null !== k.dataPoints[m - 1].y[0]) && (a.axisY.logarithmic ? (r = e[0] / k.dataPoints[m - 1].y[0], 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e[0] - k.dataPoints[m - 1].y[0], 0 > r && (r *= -1), d.minDiff > r && 0 !== r && (d.minDiff = r))));
                        if (!(b < s) || p) {
                            if (!p && (p = !0, 0 < m)) {
                                m -= 2;
                                g = h;
        ...
        n.prototype._processSpecificPlotUnit = function(a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo,
                        b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var t = this.data[a.dataSeriesIndexes[l]],
                        C = 0,
                        k = !1,
                        m = !1,
                    ...
                    if ("normal" === t.axisPlacement || "xySwapped" === t.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : a.axisX.logarithmic ? 0 : -Infinity,
                        g = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum :
                    ...
                    if (t.dataPoints[C].x && t.dataPoints[C].x.getTime || "dateTime" === t.xValueType) f = !0;
                    for (C = 0; C < t.dataPoints.length; C++) "undefined" !== typeof t.dataPoints[C].isCumulativeSum && !0 === t.dataPoints[C].isCumulativeSum ? (t.dataPointEOs[C].cumulativeSumYStartValue = 0, t.dataPointEOs[C].cumulativeSum = 0 === C ? 0 : t.dataPointEOs[C - 1].cumulativeSum, t.dataPoints[C].y = 0 ===
                        ...
                        0 === C ? e : t.dataPointEOs[C - 1].cumulativeSum + e, b += e);
                    for (C = 0; C < t.dataPoints.length; C++)
                        if ("undefined" === typeof t.dataPoints[C].x && (t.dataPoints[C].x = C + (a.axisX.logarithmic ? 1 : 0)), t.dataPoints[C].x.getTime ? (f = !0, b = t.dataPoints[C].x.getTime()) : b = t.dataPoints[C].x, e = t.dataPoints[C].y, b < c.min && (c.min = b), b > c.max && (c.max = b), t.dataPointEOs[C].cumulativeSum < d.min && (d.min = t.dataPointEOs[C].cumulativeSum), t.dataPointEOs[C].cumulativeSum > d.max && (d.max = t.dataPointEOs[C].cumulativeSum), 0 < C && (a.axisX.logarithmic ? (p =
                            ...
                            t.dataPointEOs[C].cumulativeSum > d.viewPortMax && (d.viewPortMax =
        ...
        n.prototype.calculateAutoBreaks = function() {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c)
                        for (var d = a.axisY.dataInfo, g = a.axisX.dataInfo, f, k = g.min, l = g.max, m = d.min, p = d.max, g = g._dataRanges, d = d._dataRanges, q, t = 0, C = 0; C < a.dataSeriesIndexes.length; C++) {
                            var h = e.data[a.dataSeriesIndexes[C]];
                            if (!(4 > h.dataPoints.length))
                                for (t = 0; t < h.dataPoints.length; t++)
                                    if (b && (q = (l + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100,
                                            f = h.dataPoints[t].x.getTime ? h.dataPoints[t].x.getTime() : h.dataPoints[t].x, q = Math.floor((f - k) / q), f < g[q].min && (g[q].min = f), f > g[q].max && (g[q].max = f)), c) {
                                        var n = (p + 1 - m) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100;
                                        if ((f = "waterfall" === a.type ? h.dataPointEOs[t].cumulativeSum : h.dataPoints[t].y) && f.length)
                                            for (var w = 0; w < f.length; w++) q = Math.floor((f[w] - m) / n), f[w] < d[q].min && (d[q].min = f[w]), f[w] > d[q].max && (d[q].max = f[w]);
                                        else s(f) || (q = Math.floor((f - m) / n), f < d[q].min && (d[q].min = f), f >
                                            d[q].max && (d[q].max = f))
                                    }
                        }
                }
            ...
            function c(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks)
                    for (var b = a.axisX.dataInfo, c = b.min, d = b.max, g = b._dataRanges, f, k = 0, l = 0; l < a.dataSeriesIndexes.length; l++) {
                        var m = e.data[a.dataSeriesIndexes[l]];
                        if (!(4 > m.dataPoints.length))
                            for (k = 0; k < m.dataPoints.length; k++) f = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = m.dataPoints[k].x.getTime ?
                                m.dataPoints[k].x.getTime() : m.dataPoints[k].x, f = Math.floor((b - c) / f), b < g[f].min && (g[f].min = b), b > g[f].max && (g[f].max = b)
                    }
            }
            for (var b, e = this, f = !1, l = 0; l < this._axes.length; l++)
                if (this._axes[l].scaleBreaks && this._axes[l].scaleBreaks.autoCalculate && 1 <= this._axes[l].scaleBreaks.maxNumberOfAutoBreaks) {
                    ...
                    for (var t = 0; t < 100 / Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) || 10, 10); t++) this._axes[l].dataInfo._dataRanges.push({
                        min: Infinity,
                        max: -Infinity
                    })
                } if (f) {
                for (l =
                    0; l < this.plotInfo.plotTypes.length; l++)
                    for (f = this.plotInfo.plotTypes[l], t = 0; t < f.plotUnits.length; t++) b = f.plotUnits[t], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" === b.type || "scatter" === b.type || "candlestick" === b.type || "ohlc" === b.type || "rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type || "waterfall" === b.type || "error" === b.type || "boxAndWhisker" ===
                        b.type ? d(b) : 0 <= b.type.indexOf("stacked") && c(b);
                for (l = 0; l < this._axes.length; l++)
                    if (this._axes[l].dataInfo._dataRanges) {
                        ...
                        if (this._axes[l].dataInfo.dataPointYNegativeSums) {
                            ...
                            m = k;
                            for (t in q) q.hasOwnProperty(t) && !isNaN(t) && (p = -1 * q[t], s(p) || (g = Math.floor((p - C) / b), p < m[g].min && (m[g].min = p), p > m[g].max && (m[g].max = p)));
                            ...
                            for (t = 0; t < this._axes[l].scaleBreaks.customBreaks.length; t++)
                                for (b = 0; b < f.length; b++)
                                    if (this._axes[l].scaleBreaks.customBreaks[t].startValue <= f[b].start && f[b].start <= this._axes[l].scaleBreaks.customBreaks[t].endValue || this._axes[l].scaleBreaks.customBreaks[t].startValue <= f[b].start && f[b].start <= this._axes[l].scaleBreaks.customBreaks[t].endValue || f[b].start <= this._axes[l].scaleBreaks.customBreaks[t].startValue &&
                                        this._axes[l].scaleBreaks.customBreaks[t].startValue <= f[b].end || f[b].start <= this._axes[l].scaleBreaks.customBreaks[t].endValue && this._axes[l].scaleBreaks.customBreaks[t].endValue <= f[b].end) f.splice(b, 1), b--;
                        f.sort(function(a, b) {
                            return b.diff - a.diff
                        });
                        for (t = 0; t < Math.min(f.length, this._axes[l].scaleBreaks.maxNumberOfAutoBreaks); t++) b = a(f[t].start, f[t].end, this._axes[l].logarithmic ? this._axes[l].dataInfo.max / this._axes[l].dataInfo.min : this._axes[l].dataInfo.max - this._axes[l].dataInfo.min, this._axes[l].logarithmic),
                            this._axes[l].scaleBreaks.autoBreaks.push(new aa(this, "autoBreaks", b, t, ++this._eventManager.lastObjectId, this._axes[l].scaleBreaks)), this._axes[l].scaleBreaks._appliedBreaks.push(this._axes[l].scaleBreaks.autoBreaks[this._axes[l].scaleBreaks.autoBreaks.length - 1]);
        ...
        n.prototype.getDataPointAtXY = function(a, d, c) {
            ...
            for (c = 0; c < b.length; c++)
                if ("line" === b[c].dataSeries.type || "stepLine" === b[c].dataSeries.type ||
                    "area" === b[c].dataSeries.type || "stepArea" === b[c].dataSeries.type)
                ...
                if (!(c &&
                    ...
                    if (this._lastTouchData.scroll && this.zoomEnabled) this.isDrag && this.resetOverlayedCanvas(), this.isDrag = !1;
                        ...
                        for (c = 0; c < d.length; c++)
                            if (e = d[c], l = document.createEvent("MouseEvent"), l.initMouseEvent(e, !0, !0, window, 1, b.screenX, b.screenY, b.clientX, b.clientY, !1,
        ...
        n.prototype._dispatchRangeEvent = function(a, d) {
            ...
            this.axisY2 &&
                0 < this.axisY2.length && b.push("axisY2");
        ...
        n.prototype._mouseEventHandler = function(a) {
            ...
            n.capturedEventParam && (b = n.capturedEventParam, "mouseup" === c && (n.capturedEventParam = null, b.chart.overlaidCanvas.releaseCapture ? b.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup", b.chart._mouseEventHandler, !1)), b.hasOwnProperty(c) && ("mouseup" !== c || b.chart.overlaidCanvas.releaseCapture ? a.target !== b.chart.overlaidCanvas && w || b[c].call(b.context, d.x, d.y) : a.target !==
                b.chart.overlaidCanvas && (b.chart.isDrag = !1)));
            if (this.interactivityEnabled)
                if (this._ignoreNextEvent) this._ignoreNextEvent = !1;
                else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), Ia && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which), "mouseup" === c && window.console.log("mouseup")), !e) {
                if (!n.capturedEventParam && this._events) {
                    for (var f = 0; f < this._events.length; f++)
                        if (this._events[f].hasOwnProperty(c))
                            if (b = this._events[f],
                                e = b.bounds, d.x >= e.x1 && d.x <= e.x2 && d.y >= e.y1 && d.y <= e.y2) {
                                b[c].call(b.context, d.x, d.y);
                                "mousedown" === c && !0 === b.capture ? (n.capturedEventParam = b, this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener("mouseup", this._mouseEventHandler, !1)) : "mouseup" === c && (b.chart.overlaidCanvas.releaseCapture ? b.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup", this._mouseEventHandler, !1));
                                break
                            } else b = null;
                ...
                if (d.x < c.x1 || d.x > c.x2 || d.y < c.y1 || d.y > c.y2) {
                    ...
                    for (f = 0; f < this.axisX.length; f++) this.axisX[f].crosshair && this.axisX[f].crosshair.enabled && (this.axisX[f].crosshair.hide(), this.axisX[f].crosshair.dispatchEvent("hidden", {
                        chart: this,
                    ...
                    for (f = 0; f < this.axisY.length; f++) this.axisY[f].crosshair && this.axisY[f].crosshair.enabled && (this.axisY[f].crosshair.hide(), this.axisY[f].crosshair.dispatchEvent("hidden", {
                        chart: this,
                        axis: this.axisY[f].options
                    }, this.axisY[f].crosshair));
                    for (f = 0; f < this.axisY2.length; f++) this.axisY2[f].crosshair &&
                        this.axisY2[f].crosshair.enabled && (this.axisY2[f].crosshair.hide(), this.axisY2[f].crosshair.dispatchEvent("hidden", {
                            chart: this,
        ...
        n.prototype._plotAreaMouseUp = function(a, d) {
            ...
            if ("none" !== this.plotInfo.axisPlacement) {
                ...
                if (this.axisX2 && 0 < this.axisX2.length)
                    for (l = 0; l < this.axisX2.length; l++) this.axisX2[l].crosshair && this.axisX2[l].crosshair.enabled && this.axisX2[l].crosshair.renderLabel();
                if (this.axisY && 0 < this.axisY.length)
        ...
        n.prototype._plotAreaMouseMove = function(a, d) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if (2 < Math.abs(c) && 8 > Math.abs(c) &&
                    ...
                    for (var t = 0; t < this.axisX.length; t++) this.axisX[t].crosshair && this.axisX[t].crosshair.enabled && (this.axisX[t].crosshair.hide(), this.axisX[t].crosshair.dispatchEvent("hidden", {
                        chart: this,
                        axis: this.axisX[t].options
                    }, this.axisX[t].crosshair));
                    for (t = 0; t < this.axisX2.length; t++) this.axisX2[t].crosshair && this.axisX2[t].crosshair.enabled &&
                        (this.axisX2[t].crosshair.hide(), this.axisX2[t].crosshair.dispatchEvent("hidden", {
                            chart: this,
                            axis: this.axisX2[t].options
                        }, this.axisX2[t].crosshair));
                    for (t = 0; t < this.axisY.length; t++) this.axisY[t].crosshair && this.axisY[t].crosshair.enabled && (this.axisY[t].crosshair.hide(), this.axisY[t].crosshair.dispatchEvent("hidden", {
                        chart: this,
                        axis: this.axisY[t].options
                    }, this.axisY[t].crosshair));
                    for (t = 0; t < this.axisY2.length; t++) this.axisY2[t].crosshair && this.axisY2[t].crosshair.enabled && (this.axisY2[t].crosshair.hide(),
                        this.axisY2[t].crosshair.dispatchEvent("hidden", {
                            chart: this,
                            axis: this.axisY2[t].options
                ...
                if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
                    ...
                    }, clearTimeout(l._panTimerId), l._panTimerId = setTimeout(function(b,
                        c, e, f) {
                        return function() {
                            l._zoomPanToSelectedRegion(b, c, e, f, !0) && (l._dispatchRangeEvent("rangeChanging", "pan"), l.stockChart && (l.stockChart.navigator && l.stockChart.navigator.enabled) && (l.stockChart._rangeEventParameter.type = "rangeChanging", l.stockChart.dispatchEvent("rangeChanging", l.stockChart._rangeEventParameter, l.stockChart)), l.render(), l._dispatchRangeEvent("rangeChanged", "pan"), l.stockChart && (l.stockChart.navigator && l.stockChart.navigator.enabled) && (l.stockChart._rangeEventParameter.type = "rangeChanged",
                                l.stockChart.dispatchEvent("rangeChanged", l.stockChart._rangeEventParameter, l.stockChart)), l.dragStartPoint.x = a, l.dragStartPoint.y = d)
                        }
                ...
                if (this.axisX && 0 < this.axisX.length)
                    for (e = 0; e < this.axisX.length; e++) this.axisX[e].crosshair && this.axisX[e].crosshair.enabled &&
                ...
                if (this.axisY2 && 0 < this.axisY2.length)
                    for (e = 0; e < this.axisY2.length; e++) this.axisY2[e].crosshair && this.axisY2[e].crosshair.enabled && this.axisY2[e].renderCrosshair(a,
                        d);
                if (this.axisX && 0 < this.axisX.length)
        ...
        n.prototype._zoomPanToSelectedRegion = function(a, d, c, b, e) {
            ...
            c = a.axesRanges;
            if (a.isValid)
                for (b = 0; b < d.length; b++) e = c[b], d[b].setViewPortRange(e.val1, e.val2), this.syncCharts && "y" != this.zoomType && this.syncCharts(e.val1, e.val2), this.stockChart && (this.stockChart._rangeEventParameter = {
                    stockChart: this.stockChart,
                    source: "chart",
                    index: this.stockChart.charts.indexOf(this),
                    minimum: e.val1,
        ...
        n.prototype.validateRegion = function(a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), t = !1, C = [], k = [], m = [], p = 0; p < this._axes.length; p++)("axisX" === this._axes[p].type && f || "axisY" === this._axes[p].type && l) && k.push(this._axes[p]);
            for (l = 0; l < k.length; l++) {
                ...
                if (isFinite(p.dataInfo.minDiff))
                    if (r = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) && (p.logarithmic && r < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && r < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) C.push(p), m.push({
                        val1: q,
                        val2: g
                    }), t = !0;
                    else if (!e) {
        ...
        n.prototype.preparePlotArea = function() {
            ...
            if ((this.axisX[0] || this.axisX2[0]) && (this.axisY[0] || this.axisY2[0])) {
                ...
                if (this.axisY && 0 < this.axisY.length && this.axisY[0]) {
                    ...
                    a.x2 = d.x2 > c.lineCoordinates.x2 ?
                        d.x2 : c.lineCoordinates.x2;
            ...
            } else d = this.layoutManager.getFreeSpace(), a.x1 = d.x1, a.x2 = d.x2, a.y1 = d.y1, a.y2 = d.y2, a.width = d.width,
                a.height = d.height;
        ...
        n.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var m = this._indexLabels[a],
                    ...
                    q, g, l = ma("indexLabelFontColor", m.dataPoint, m.dataSeries),
                    r = ma("indexLabelFontSize",
                ...
                var ba = ma("indexLabelLineDashType", m.dataPoint, m.dataSeries),
                    ...
                    s(m.dataSeries.options.indexLabelLineThickness) ? 0 : m.dataSeries.options.indexLabelLineThickness : m.dataPoint.indexLabelLineThickness,
                    b = 0 < n ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0,
                    x = {
                        percent: null,
                        total: null
                    },
                    z = null;
                if (0 <= m.dataSeries.type.indexOf("stacked") || "pie" === m.dataSeries.type || "doughnut" === m.dataSeries.type) x = this.getPercentAndTotal(m.dataSeries, m.dataPoint);
                if (m.dataSeries.indexLabelFormatter || m.dataPoint.indexLabelFormatter) z = {
                    chart: this,
                ...
                if (null !==
                    ...
                    if ("stackedarea100" === p) {
                        ...
                        if (m.dataPoint.x < e.viewportMinimum || m.dataPoint.x > e.viewportMaximum ||
                            m.dataPoint.y < f.viewportMinimum || m.dataPoint.y > f.viewportMaximum) continue
                    } else if (0 <= p.indexOf("column") || "waterfall" === p || "error" === p && !m.axisSwapped) {
                        if (m.dataPoint.x < e.viewportMinimum || m.dataPoint.x > e.viewportMaximum || m.bounds.y1 > c.y2 || m.bounds.y2 < c.y1) continue
                    } else if (0 <= p.indexOf("bar") || "error" === p) {
                        if (m.dataPoint.x < e.viewportMinimum || m.dataPoint.x > e.viewportMaximum || m.bounds.x1 > c.x2 || m.bounds.x2 < c.x1) continue
                    } else if ("candlestick" === p || "ohlc" === p) {
                        if (m.dataPoint.x < e.viewportMinimum || m.dataPoint.x >
                            e.viewportMaximum || Math.max.apply(null, m.dataPoint.y) < f.viewportMinimum || Math.min.apply(null, m.dataPoint.y) > f.viewportMaximum) continue
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== x ? (e = c.y1, f = c.y2, 0 < v ? (g = m.point.y + ("horizontal" === z ? r / 2 : 0) - k - t - b, g < e && (g = "auto" === x ? Math.max(m.point.y, e) + r / 2 + t : e + r / 2 + t, A = g + k > m.point.y)) : (g = m.point.y + r / 2 + t + b, g > f - k && (g = "auto" === x ? Math.min(m.point.y, f) + r / 2 - k - t : f + r / 2 - k, A = g < m.point.y))) : (e = Math.max(m.bounds.y1, c.y1), f = Math.min(m.bounds.y2, c.y2 - k + r / 2), b = 0 <= p.indexOf("range") || "error" === p ? 0 < v ? Math.max(m.bounds.y1, c.y1) + r / 2 + t : Math.min(m.bounds.y2, c.y2) + r / 2 - k + t : (Math.max(m.bounds.y1, c.y1) + Math.min(m.bounds.y2, c.y2)) /
                            2 - k / 2 + r / 2 + ("horizontal" === z ? t : 0), 0 < v ? (g = Math.max(m.point.y, b), g < e && ("bubble" === p || "scatter" === p) && (g = Math.max(m.point.y - k - t, c.y1 + t))) : (g = Math.min(m.point.y, b), g > f - k - t && ("bubble" === p || "scatter" === p) && (g = Math.min(m.point.y + t, c.y2 - k - t))), g = Math.min(g, f))
                    } else 0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? (x = "auto", l = 4) : 0 <= p.indexOf("stacked") ? "auto" === x && (x = "inside") : "bubble" === p && (x = "inside"), g = m.point.y + r / 2 - k / 2 + t, "inside" !== x ? (e = c.x1, f = c.x2, 0 > v ? (q = m.point.x - ("horizontal" === z ?
                        ...
                        b) - ("horizontal" === z ? C / 2 : 0) : Math.min(m.point.x, b) - C / 2, q = Math.max(q, e));
                    "vertical" === z && (g += k - r / 2);
                    h.x = q;
                    h.y = g;
                    h.render(!0);
                    n && ("inside" !== x && (0 > p.indexOf("bar") && ("error" !== p || !m.axisSwapped) && m.point.x > c.x1 && m.point.x < c.x2 || !A) && (0 > p.indexOf("column") && ("error" !== p || m.axisSwapped) && m.point.y > c.y1 && m.point.y < c.y2 || !A)) && (d.lineWidth = n, d.strokeStyle = u ? u : "gray", d.setLineDash && d.setLineDash(J(ba, n)), d.beginPath(), d.moveTo(m.point.x, m.point.y), 0 <= p.indexOf("bar") || "error" === p && m.axisSwapped ? d.lineTo(q +
                        ...
                        z ? g - k < m.point.y ? 0 : -k : (g + k < m.point.y ? k : 0) - r / 2)), d.stroke())
                }
            }
            d = {
                source: d,
            ...
            for (a = 0; a < this._indexLabels.length; a++) m = this._indexLabels[a], h = ma("indexLabelBackgroundColor", m.dataPoint, m.dataSeries), m.dataSeries.indexLabelBackgroundColor = s(h) ? w ? "transparent" : null : h;
            return d
        };
                ...
                for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < m.length) {
                        for (var z = !1, u = 0; u < m.length; u++)
                            if (n = m[u].x.getTime ? m[u].x.getTime() : m[u].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || z || s) && (c.stroke(), w && b.stroke()), z = !0;
                                else {
                                    ...
                                    s || z ? (!s && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(n, x), w && b.lineTo(n, x)) : (c.beginPath(), c.moveTo(n, x), w && (b.beginPath(),
                                        b.moveTo(n, x))), z = s = !1) : (c.lineTo(n, x), w && b.lineTo(n, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(n, x), w && (b.stroke(), b.beginPath(), b.moveTo(n, x))));
                                    l = {
                                        x: n,
                                        y: x
                                    };
                                    u < m.length - 1 && (h !== (m[u].lineColor || r) || p !== (m[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(n, x), h = m[u].lineColor || r, c.strokeStyle = h, c.setLineDash && (m[u].lineDashType ? (p = m[u].lineDashType, c.setLineDash(J(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
                                    if (0 !== m[u].markerSize && (0 < m[u].markerSize || 0 < k.markerSize)) {
                                        var D =
                                            k.getMarkerProperties(u, n, x, c);
                                        f.push(D);
                                        H = X(H);
                                        w && f.push({
                                            x: n,
                                    ...
                                    }(m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "line",
                                        dataPoint: m[u],
                                        dataSeries: k,
                                        point: {
            ...
            function(a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
                        ...
                        if (0 < m.length) {
                            for (var z = !1, u = 0; u < m.length; u++)
                                if (n = m[u].getTime ? m[u].x.getTime() : m[u].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))
                                    if ("number" !== typeof m[u].y) 0 <
                                        u && !(k.connectNullData || z || s) && (c.stroke(), w && b.stroke()), z = !0;
                                    else {
                                        var H = x;
                                        n = a.axisX.convertValueToPixel(n);
                                        x = a.axisY.convertValueToPixel(m[u].y);
                                        ...
                                        s || z ? (!s && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)),
                                            c.lineTo(n, H), c.lineTo(n, x), w && (b.lineTo(n, H), b.lineTo(n, x))) : (c.beginPath(), c.moveTo(n, x), w && (b.beginPath(), b.moveTo(n, x))), z = s = !1) : (c.lineTo(n, H), w && b.lineTo(n, H), c.lineTo(n, x), w && b.lineTo(n, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(n, x), w && (b.stroke(), b.beginPath(), b.moveTo(n, x))));
                                        l = {
                                            x: n,
                                            y: x
                                        };
                                        u < m.length - 1 && (h !== (m[u].lineColor || r) || p !== (m[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(n, x), h = m[u].lineColor || r, c.strokeStyle = h, c.setLineDash && (m[u].lineDashType ? (p = m[u].lineDashType,
                                            c.setLineDash(J(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
                                        0 !== m[u].markerSize && (0 < m[u].markerSize || 0 < k.markerSize) && (H = k.getMarkerProperties(u, n, x, c), f.push(H), D = X(D), w && f.push({
                                            x: n,
                                            y: x,
                                            ctx: b,
                                            type: H.type,
                                        ...
                                        (m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                            ...
                                            direction: 0 > m[u].y === a.axisY.reversed ?
                                                1 : -1,
                                            color: r
                                        })
                                    } c.stroke();
                ...
                for (var l = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < m.length)
                        for (n = !1, s = 0; s < m.length; s++)
                            if (u = m[s].getTime ? m[s].x.getTime() : m[s].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !n)))
                                if ("number" !== typeof m[s].y) 0 < s && !n && (k.connectNullData ? b.setLineDash && (0 < x.length && (k.options.nullDataLineDashType || !m[s - 1].lineDashType)) && (x[x.length -
                                    1].newLineDashArray = q, p = k.nullDataLineDashType) : (d(x), x = [])), n = !0;
                                else {
                                    ...
                                    s < m.length - 1 && (h !== (m[s].lineColor || r) || p !== (m[s].lineDashType || k.lineDashType)) && (h = m[s].lineColor || r, x[x.length - 1].newStrokeStyle = h, b.setLineDash && (m[s].lineDashType ? (p = m[s].lineDashType, x[x.length - 1].newLineDashArray =
                                        J(p, k.lineThickness)) : (p = k.lineDashType, x[x.length - 1].newLineDashArray = g)));
                                    if (0 !== m[s].markerSize && (0 < m[s].markerSize || 0 < k.markerSize)) {
                                        ...
                                        direction: 0 > m[s].y === a.axisY.reversed ?
                                            1 : -1,
                                        color: r
                                    });
                                    n = !1
        ...
        n.prototype.renderColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    l, t, C, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                this.dataPointMaxWidth && f > m && (f = Math.min(this.options.dataPointWidth ?
                    this.dataPointWidth : Infinity, m));
                    ...
                    if (0 < r.length)
                        for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < r.length; f++)
                            if (r[f].getTime ? C = r[f].x.getTime() : C = r[f].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                                ...
                                Y(c, a.axisX.reversed ? s : l, t, a.axisX.reversed ? l : s, u, b, 0, null, h && (a.axisY.reversed ? 0 > r[f].y : 0 <= r[f].y), (a.axisY.reversed ? 0 <= r[f].y : 0 > r[f].y) && h, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                ...
                                b = X(b);
                                w && Y(this._eventManager.ghostCtx, a.axisX.reversed ? s : l, t, a.axisX.reversed ? l : s, u, b, 0, null, !1, !1,
                                    !1, !1);
        ...
        n.prototype.renderStackedColumn =
            function(a) {
                var d = a.targetCanvasCtx || this.plotArea.ctx,
                    c = w ? this._preRenderCtx : d;
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var b = null,
                        ...
                        C = [],
                        k = 0,
                        m, p, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    ...
                    for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                        ...
                        if (0 < u.length) {
                            ...
                            for (k = 0; k < u.length; k++)
                                if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                                    "number" === typeof u[k].y) {
                                    m = a.axisX.convertValueToPixel(b);
                                    m = m - a.plotType.plotUnits.length * r / 2 + a.index * r << 0;
                                    var x = m + r << 0,
                                        z;
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[b] = u[k].y + (t[b] ? t[b] : 0), 0 < t[b] && (p = a.axisY.convertValueToPixel(t[b]), z = "undefined" !== typeof f[b] ? f[b] : q, f[b] = p);
                                    else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) C[b] = u[k].y + (C[b] ? C[b] : 0), z = a.axisY.convertValueToPixel(C[b]), p = "undefined" !== typeof l[b] ?
                                        l[b] : q, l[b] = z;
                                        ...
                                        z = q - H;
                                        f[b] = H + (z - p)
                                    } else H = l[b] ? l[b] : 0, z = p + H, p = q + H, l[b] = H + (z - p);
                                    b = u[k].color ? u[k].color : s._colorSet[k % s._colorSet.length];
                                    Y(c, m, a.axisY.reversed ? z : p, x, a.axisY.reversed ? p : z, b, 0, null, n && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y), (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) && n, !1, !1, s.fillOpacity);
                                    b = s.dataPointIds[k];
                                    this._eventManager.objectMap[b] = {
                                        id: b,
                                        objectType: "dataPoint",
                                    ...
                                    b = X(b);
                                    w && Y(this._eventManager.ghostCtx, m, p, x, z, b, 0, null, !1, !1, !1, !1);
                                    (u[k].indexLabel || s.indexLabel || u[k].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                    var h = a.dataSeriesIndexes[g],
                        ...
                        u = s.dataPoints;
                    if (0 < u.length)
                        for (var n = 5 < r && s.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin ||
                                    b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                m = a.axisX.convertValueToPixel(b);
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                    ...
                                    0 >= u[k].y) C[b] = p + ("undefined" !== typeof C[b] ? C[b] : 0), z = a.axisY.convertValueToPixel(C[b]), p = l[b] ? l[b] : q, l[b] = z;
                                ...
                                b = u[k].color ? u[k].color : s._colorSet[k % s._colorSet.length];
                                Y(c, m, a.axisY.reversed ? z : p,
                                    x, a.axisY.reversed ? p : z, b, 0, null, n && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y), (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) && n, !1, !1, s.fillOpacity);
                                b = s.dataPointIds[k];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
        ...
        n.prototype.renderBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    l, t, C, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                    ...
                    if (0 < r.length) {
                        ...
                        for (f = 0; f < r.length; f++)
                            if (r[f].getTime ? C = r[f].x.getTime() : C = r[f].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                                ...
                                t = a.axisX.reversed ? t + a.plotType.totalDataSeries *
                                    p / 2 - (a.previousDataSeriesCount + m) * p << 0 : t - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount + m) * p << 0;
                                var s = a.axisX.reversed ? t - p << 0 : t + p << 0,
                                    u;
                                0 <= r[f].y ? u = k : (u = l, l = k);
                                b = r[f].color ? r[f].color : g._colorSet[f % g._colorSet.length];
                                Y(c, a.axisY.reversed ? l : u, a.axisX.reversed ? s : t, a.axisY.reversed ? u : l, a.axisX.reversed ? t : s, b, 0, null, h, !1, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = X(b);
                                w && Y(this._eventManager.ghostCtx,
                                    u, a.axisX.reversed ? s : t, l, a.axisX.reversed ? t : s, b, 0, null, !1, !1, !1, !1);
                                (r[f].indexLabel || g.indexLabel || r[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "bar",
                                    dataPoint: r[f],
                                    dataSeries: g,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < u.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x,
                                !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                p = a.axisX.convertValueToPixel(b);
                                p = p - a.plotType.plotUnits.length * r / 2 + a.index * r << 0;
                                var x = p + r << 0,
                                    z;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[b] = u[k].y + (t[b] ? t[b] : 0), 0 < t[b] && (z = f[b] ? f[b] : q, f[b] = m = a.axisY.convertValueToPixel(t[b]));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) C[b] = u[k].y + (C[b] ? C[b] : 0), m = l[b] ? l[b] :
                                    q, l[b] = z = a.axisY.convertValueToPixel(C[b]);
                                else if (m = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) {
                                    var H = f[b] ? f[b] : 0;
                                    z = q + H;
                                    m += H;
                                    f[b] = H + (m - z)
                                } else H = l[b] ? l[b] : 0, z = m - H, m = q - H, l[b] = H + (m - z);
                                b = u[k].color ? u[k].color : s._colorSet[k % s._colorSet.length];
                                Y(c, a.axisY.reversed ? m : z, p, a.axisY.reversed ? z : m, x, b, 0, null, n, !1, !1, !1, s.fillOpacity);
                                b = s.dataPointIds[k];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
        ...
        n.prototype.renderStackedBar100 =
            function(a) {
                var d = a.targetCanvasCtx || this.plotArea.ctx,
                    c = w ? this._preRenderCtx : d;
                if (!(0 >= a.dataSeriesIndexes.length)) {
                        ...
                        if (0 < u.length) {
                            ...
                            for (k = 0; k < u.length; k++)
                                if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin ||
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                    ...
                                    } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) C[b] =
                                        x + (C[b] ? C[b] : 0), m = l[b] ? l[b] : q, l[b] = x = a.axisY.convertValueToPixel(C[b]);
                                        ...
                                        f[b] = H + (m - x)
                                    } else H = l[b] ? l[b] : 0, x = m - H, m = q - H, a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.x1 - x) && (x = e.x1), l[b] = H + (m - x);
                                    b = u[k].color ? u[k].color : s._colorSet[k % s._colorSet.length];
                                    Y(c, a.axisY.reversed ? m : x, p, a.axisY.reversed ? x : m, z, b, 0, null, n, !1, !1, !1, s.fillOpacity);
                                    b = s.dataPointIds[k];
                                    this._eventManager.objectMap[b] = {
                                        id: b,
                                        objectType: "dataPoint",
                                    ...
                                    b = X(b);
                                    w && Y(this._eventManager.ghostCtx, x, p, m, z, b, 0, null, !1, !1, !1, !1);
                                    (u[k].indexLabel || s.indexLabel || u[k].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({
        ...
        n.prototype.renderArea = function(a) {
            ...
            function b() {
                H && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? z = x : 0 > a.axisY.viewportMaximum ? z = t.y1 : 0 < a.axisY.viewportMinimum && (z = x), f.lineTo(s, z), f.lineTo(H.x, z), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (l.lineTo(s, z), l.lineTo(H.x, z), l.closePath(), l.fill()), f.beginPath(), f.moveTo(s,
                    u), l.beginPath(), l.moveTo(s, u), H = {
                    x: s,
                    y: u
                })
            }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    d = !0;
                    var h = 0,
                        s, u, n, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        z, H = null;
                    if (0 < r.length) {
                        ...
                        for (var ea = !0; h < r.length; h++)
                            if (n = r[h].x.getTime ?
                                r[h].x.getTime() : r[h].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ea)))
                                if ("number" !== typeof r[h].y) g.connectNullData || (ea || d) || b(), ea = !0;
                                else {
                                    s = a.axisX.convertValueToPixel(n);
                                    u = a.axisY.convertValueToPixel(r[h].y);
                                    d || ea ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = s, c = u, s = m.x, u = m.y, b(), f.moveTo(m.x, m.y), s = d, u = c, H = m, c = g.nullDataLineDashType, f.setLineDash(L)), f.lineTo(s,
                                        u), w && l.lineTo(s, u)) : (f.beginPath(), f.moveTo(s, u), w && (l.beginPath(), l.moveTo(s, u)), H = {
                                        x: s,
                                        y: u
                                    }), ea = d = !1) : (f.lineTo(s, u), w && l.lineTo(s, u), 0 == h % 250 && b());
                                    m = {
                                        x: s,
                                        y: u
                                    };
                                    h < r.length - 1 && (A !== (r[h].lineColor || v) || c !== (r[h].lineDashType || g.lineDashType)) && (b(), A = r[h].lineColor || v, f.strokeStyle = A, f.setLineDash && (r[h].lineDashType ? (c = r[h].lineDashType, f.setLineDash(J(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(S))));
                                    ...
                                    0 !== r[h].markerSize && (0 < r[h].markerSize || 0 < g.markerSize) && (n = g.getMarkerProperties(h, s, u, f), C.push(n), $ = X($), w && C.push({
                                        x: s,
                                        y: u,
                                        ctx: l,
                                        type: n.type,
        ...
        n.prototype.renderSplineArea = function(a) {
            function d() {
                ...
                if (0 < c.length) {
                    ...
                    a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum &&
                        0 <= a.axisY.viewportMaximum ? n = s : 0 > a.axisY.viewportMaximum ? n = f.y1 : 0 < a.axisY.viewportMinimum && (n = s);
                    u = {
                        x: c[0].x,
                        y: c[0].y
                    };
                    ...
                    b.fill();
                    b.globalAlpha = 1;
                    w && (e.lineTo(c[c.length - 1].x, n), e.lineTo(u.x, n), e.closePath(), e.fill())
                }
            }
            var c = a.targetCanvasCtx || this.plotArea.ctx,
                b = w ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    var l = [],
                        q = 0,
                        g, r, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        n, u = null,
                        y = [];
                    if (0 < p.length) {
                        ...
                        for (r = !1; q < p.length; q++)
                            if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r)))
                                if ("number" !== typeof p[q].y) 0 < q && !r && (m.connectNullData ? b.setLineDash && (0 < y.length && (m.options.nullDataLineDashType ||
                                    !p[q - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = A, D = m.nullDataLineDashType) : (d(), y = [])), r = !0;
                                else {
                                    ...
                                    q < p.length - 1 && (H !== (p[q].lineColor || z) || D !== (p[q].lineDashType || m.lineDashType)) && (H = p[q].lineColor || z, y[y.length - 1].newStrokeStyle = H, b.setLineDash && (p[q].lineDashType ? (D =
                                        p[q].lineDashType, y[y.length - 1].newLineDashArray = J(D, m.lineThickness)) : (D = m.lineDashType, y[y.length - 1].newLineDashArray = B)));
        ...
        n.prototype.renderStepArea = function(a) {
            ...
            function b() {
                H && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? z = x : 0 > a.axisY.viewportMaximum ? z = t.y1 : 0 < a.axisY.viewportMinimum && (z = x), f.lineTo(n, z), f.lineTo(H.x, z), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha =
                    1, w && (l.lineTo(n, z), l.lineTo(H.x, z), l.closePath(), l.fill()), f.beginPath(), f.moveTo(n, u), l.beginPath(), l.moveTo(n, u), H = {
                        x: n,
                        y: u
                    })
            }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    d = !0;
                    var s = 0,
                        n, u, y, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        z, H = null;
                    c = !1;
                    if (0 < r.length) {
                        ...
                        for (; s < r.length; s++)
                            if (y = r[s].x.getTime ? r[s].x.getTime() : r[s].x, !(y < a.axisX.dataInfo.viewPortMin || y > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                var $ = u;
                                "number" !== typeof r[s].y ? (g.connectNullData || (c || d) || b(), c = !0) : (n = a.axisX.convertValueToPixel(y), u = a.axisY.convertValueToPixel(r[s].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || L === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = n,
                                        c = u, n = m.x, u = m.y, b(), f.moveTo(m.x, m.y), n = d, u = c, H = m, L = g.nullDataLineDashType, f.setLineDash(S)), f.lineTo(n, $), f.lineTo(n, u), w && (l.lineTo(n, $), l.lineTo(n, u))) : (f.beginPath(), f.moveTo(n, u), w && (l.beginPath(), l.moveTo(n, u)), H = {
                                        x: n,
                                        y: u
                                    }), c = d = !1) : (f.lineTo(n, $), w && l.lineTo(n, $), f.lineTo(n, u), w && l.lineTo(n, u), 0 == s % 250 && b()), m = {
                                        x: n,
                                        y: u
                                    }, s < r.length - 1 && (A !== (r[s].lineColor || v) || L !== (r[s].lineDashType || g.lineDashType)) && (b(), A = r[s].lineColor || v, f.strokeStyle = A, f.setLineDash && (r[s].lineDashType ? (L = r[s].lineDashType,
                                        ...
                                        x1: n,
                                        y1: u
                                    }, 0 !== r[s].markerSize && (0 < r[s].markerSize || 0 < g.markerSize) && ($ = g.getMarkerProperties(s, n, u, f), h.push($), y = X(y), w && h.push({
                                        x: n,
                                        y: u,
                                        ctx: l,
                                        type: $.type,
                                    ...
                                    })), (r[s].indexLabel || g.indexLabel || r[s].indexLabelFormatter || g.indexLabelFormatter) &&
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) {
                    var H =
                        ...
                        v = D.dataPoints;
                    D.dataPointIndexes = [];
                    for (q = 0; q < v.length; q++) H = v[q].x.getTime ? v[q].x.getTime() : v[q].x, D.dataPointIndexes[H] = q, e[H] || (m.push(H), e[H] = !0);
                    m.sort(Ra)
                }
                for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    if (0 < m.length) {
                        ...
                        for (var $ = !0, q = 0; q < m.length; q++) {
                            var f = m[q],
                                ga = null,
                                ga = 0 <= D.dataPointIndexes[f] ? v[D.dataPointIndexes[f]] : {
                                    x: f,
                                    y: null
                                };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!D.connectNullData || !$)))
                                if ("number" !== typeof ga.y) D.connectNullData || ($ || y) || d(), $ = !0;
                                else {
                                    ...
                                    h[f] = s - r;
                                    y || $ ? (!y && D.connectNullData ? (b.setLineDash && (D.options.nullDataLineDashType || x === D.lineDashType && D.lineDashType !== D.nullDataLineDashType) && (y = k.pop(), x = k[k.length - 1], d(), b.moveTo(u.x, u.y), k.push(x), k.push(y), x = D.nullDataLineDashType,
                                        b.setLineDash(S)), b.lineTo(g, r), w && n.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), w && (n.beginPath(), n.moveTo(g, r))), $ = y = !1) : (b.lineTo(g, r), w && n.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && n.moveTo(g, r), k.push({
                                        x: g,
                                        y: s - na
                                    })));
                                    u = {
                                    ...
                                    q < v.length - 1 && (L !== (v[q].lineColor || A) || x !== (v[q].lineDashType || D.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, r), k.push({
                                        x: g,
                                        y: s - na
                                    }), L = v[q].lineColor || A, b.strokeStyle = L, b.setLineDash && (v[q].lineDashType ? (x = v[q].lineDashType, b.setLineDash(J(x, D.lineThickness))) : (x =
                                        D.lineDashType, b.setLineDash(B))));
                                    ...
                                    0 <= D.dataPointIndexes[f] && 0 !== ga.markerSize && (0 < ga.markerSize || 0 < D.markerSize) && (na = D.getMarkerProperties(D.dataPointIndexes[f], g, r, b), l.push(na), f = X(ka), w && l.push({
                                        x: g,
                                        y: r,
                                        ctx: n,
                                        type: na.type,
                ...
                W.drawMarkers(l);
                w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas &&
                    b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(t.x1, t.y1, t.width, t.height), n.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        n.prototype.renderStackedArea100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    p = [],
                    q = 0,
                    g, r, s, n, u, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                b.clip();
                w && (x.beginPath(),
                    x.rect(l.x1, l.y1, l.width, l.height), x.clip());
                for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) {
                ...
                for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    if (0 < m.length) {
                        ...
                        for (var $ = !0, q = 0; q < m.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!D.connectNullData ||
                                    !$)))
                                if ("number" !== typeof ga.y) D.connectNullData || ($ || n) || d(), $ = !0;
                                else {
                                    var na;
                                    ...
                                    h[f] = y - r;
                                    n || $ ? (!n && D.connectNullData ? (b.setLineDash && (D.options.nullDataLineDashType ||
                                        u === D.lineDashType && D.lineDashType !== D.nullDataLineDashType) && (n = k.pop(), u = k[k.length - 1], d(), b.moveTo(s.x, s.y), k.push(u), k.push(n), u = D.nullDataLineDashType, b.setLineDash(S)), b.lineTo(g, r), w && x.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), w && (x.beginPath(), x.moveTo(g, r))), $ = n = !1) : (b.lineTo(g, r), w && x.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && x.moveTo(g, r), k.push({
                                        x: g,
                                        y: y - ka
                                    })));
                                    s = {
                                    ...
                                    q < v.length - 1 && (L !== (v[q].lineColor || A) || u !== (v[q].lineDashType || D.lineDashType)) && (d(), b.beginPath(), b.moveTo(g,
                                        r), k.push({
                                        x: g,
                                        y: y - ka
                                    }), L = v[q].lineColor || A, b.strokeStyle = L, b.setLineDash && (v[q].lineDashType ? (u = v[q].lineDashType, b.setLineDash(J(u, D.lineThickness))) : (u = D.lineDashType, b.setLineDash(B))));
                                    if (0 <= D.dataPointIndexes[f]) {
                                    ...
                                    0 <= D.dataPointIndexes[f] && 0 !== ga.markerSize && (0 < ga.markerSize || 0 < D.markerSize) && (ka = D.getMarkerProperties(q, g, r,
                                        b), t.push(ka), f = X(F), w && t.push({
                                        x: g,
                                        y: r,
                                        ctx: x,
                                        type: ka.type,
                ...
                W.drawMarkers(t);
                w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
            ...
            function(a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var t = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
                        for (var m = a.dataSeriesIndexes[k], p = this.data[m],
                                q = p.dataPoints, g = 0, e = 0; e < q.length; e++) f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (g = q[e].z, g > t && (t = g), g < h && (h = g));
                    for (var r = 25 * Math.PI, s = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, r), k = 0; k < a.dataSeriesIndexes.length; k++)
                        if (m = a.dataSeriesIndexes[k], p = this.data[m], q = p.dataPoints, 0 < q.length)
                            for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                                if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                                    ...
                                    var g = q[e].z,
                                        n = 2 * Math.max(Math.sqrt((t === h ? s / 2 : r + (s - r) / (t - h) * (g - h)) / Math.PI) << 0, 1),
                                    ...
                                    n = X(u);
                                    w && W.drawMarker(f, l, this._eventManager.ghostCtx, g.type, g.size, n, n, g.borderThickness);
                    ...
                    if (0 < m.length) {
                        ...
                        for (var p = 0, q = 0, e = 0; e < m.length; e++)
                            if (f = m[e].getTime ? f = m[e].x.getTime() : f = m[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                                ...
                                c.globalAlpha = 1;
                                Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && m.length > Math.min(this.plotArea.width,
                                    this.plotArea.height) || (p = k.dataPointIds[e], this._eventManager.objectMap[p] = {
                                        ...
                                        x1: f,
                                        y1: l
                                    }, p = X(p), w && W.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness), (m[e].indexLabel || k.indexLabel || m[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "scatter",
                                        dataPoint: m[e],
                                        dataSeries: k,
                                        point: {
        ...
        n.prototype.renderCandlestick = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    l = this.plotArea,
                    t = 0,
                    h, k, m, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var ba = a.dataSeriesIndexes[n],
                        ...
                        y = u.dataPoints;
                    if (0 < y.length)
                        for (var x = 5 < r && u.bevelEnabled ? !0 : !1, t = 0; t < y.length; t++)
                            if (y[t].getTime ? g = y[t].x.getTime() : g = y[t].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(y[t].y) && y[t].y.length && "number" === typeof y[t].y[0] &&
                                "number" === typeof y[t].y[1] && "number" === typeof y[t].y[2] && "number" === typeof y[t].y[3]) {
                                ...
                                "candlestick" === u.type ? (c.moveTo(h - v, m), c.lineTo(h - v, Math.min(k, q)), c.stroke(), c.moveTo(h - v, Math.max(k, q)), c.lineTo(h - v, p), c.stroke(), Y(c, z, Math.min(k, q), H, Math.max(k, q), y[t].y[0] <= y[t].y[3] ? u.risingColor : f, D, e, x, x, !1, !1, u.fillOpacity), w && (e = X(A), b.strokeStyle = e, b.moveTo(h - v, m), b.lineTo(h - v, Math.min(k,
                                    q)), b.stroke(), b.moveTo(h - v, Math.max(k, q)), b.lineTo(h - v, p), b.stroke(), Y(b, z, Math.min(k, q), H, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (c.moveTo(h - v, m), c.lineTo(h - v, p), c.stroke(), c.beginPath(), c.moveTo(h, k), c.lineTo(z, k), c.stroke(), c.beginPath(), c.moveTo(h, q), c.lineTo(H, q), c.stroke(), w && (e = X(A), b.strokeStyle = e, b.moveTo(h - v, m), b.lineTo(h - v, p), b.stroke(), b.beginPath(), b.moveTo(h, k), b.lineTo(z, k), b.stroke(), b.beginPath(), b.moveTo(h, q), b.lineTo(H, q), b.stroke()));
                                (y[t].indexLabel || u.indexLabel ||
                                    y[t].indexLabelFormatter || u.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: u.type,
                                    dataPoint: y[t],
                                    dataSeries: u,
                                    point: {
        ...
        n.prototype.renderBoxAndWhisker = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    f = this.plotArea,
                    l = 0,
                    t, h, k, m, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                ...
                for (var n = !1, n = !!a.axisY.reversed, ba = 0; ba < a.dataSeriesIndexes.length; ba++) {
                    var u = a.dataSeriesIndexes[ba],
                        y = this.data[u],
                        x = y.dataPoints;
                    if (0 < x.length)
                        for (var z = 5 < r && y.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)
                            if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3] && "number" === typeof x[l].y[4] && 5 === x[l].y.length) {
                                ...
                                var v = t - r / 2 << 0,
                                    ...
                                    B = 0 === A % 2 ? 0 : 0.5,
                                    L = x[l].whiskerColor ? x[l].whiskerColor : x[l].color ? y.whiskerColor ? y.whiskerColor : x[l].color : y.whiskerColor ? y.whiskerColor : e,
                                    ...
                                    $ = s(x[l].whiskerLength) ? s(y.options.whiskerLength) ? r : y.whiskerLength : x[l].whiskerLength,
                                    $ = "number" === typeof $ ? 0 >= $ ? 0 : $ >= r ? r : $ : "string" === typeof $ ? parseInt($) * r / 100 > r ? r : parseInt($) * r / 100 : r,
                                    ga = 1 === Math.round(S) % 2 ? 0.5 : 0,
                                    na = x[l].stemColor ? x[l].stemColor : x[l].color ? y.stemColor ? y.stemColor : x[l].color : y.stemColor ? y.stemColor : e,
                                    ka = "number" === typeof x[l].stemThickness ? x[l].stemThickness : "number" === typeof y.options.stemThickness ? y.stemThickness : A,
                                    F = 1 === Math.round(ka) % 2 ? 0.5 : 0,
                                    E = x[l].stemDashType ? x[l].stemDashType :
                                    y.stemDashType,
                                ...
                                c.save();
                                0 < ka && (c.beginPath(), c.strokeStyle = na, c.lineWidth = ka, c.setLineDash && c.setLineDash(J(E, ka)), c.moveTo(t - F, k), c.lineTo(t - F, h), c.stroke(), c.moveTo(t - F, p), c.lineTo(t - F, m), c.stroke());
                                c.restore();
                                b.lineWidth = Math.max(A, 4);
                                c.beginPath();
                                Y(c, v, Math.min(q, k), D, Math.max(k, q), Q, 0, e, n ? z : !1, n ? !1 : z, !1, !1, ta);
                                c.beginPath();
                                Y(c,
                                    v, Math.min(m, q), D, Math.max(q, m), P, 0, e, n ? !1 : z, n ? z : !1, !1, !1, ta);
                                c.beginPath();
                                c.lineWidth = A;
                                c.strokeStyle = e;
                                c.rect(v - B, Math.min(k, m) - B, D - v + 2 * B, Math.max(k, m) - Math.min(k, m) + 2 * B);
                                c.stroke();
                                c.save();
                                0 < G && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(J(N, G)), c.strokeStyle = K, c.lineWidth = G, c.moveTo(v, q - O), c.lineTo(D, q - O), c.stroke());
                                c.restore();
                                c.save();
                                0 < S && (c.beginPath(), c.setLineDash && c.setLineDash(J(ea, S)), c.strokeStyle = L, c.lineWidth = S, c.moveTo(t - $ / 2 << 0, p - ga), c.lineTo(t + $ / 2 << 0, p - ga), c.stroke(),
                                    c.moveTo(t - $ / 2 << 0, h + ga), c.lineTo(t + $ / 2 << 0, h + ga), c.stroke());
                                c.restore();
                                w && (e = X(R), b.strokeStyle = e, b.lineWidth = ka, 0 < ka && (b.moveTo(t - B - F, k), b.lineTo(t - B - F, Math.max(h, p)), b.stroke(), b.moveTo(t - B - F, Math.min(h, p)), b.lineTo(t - B - F, m), b.stroke()), Y(b, v, Math.max(k, m), D, Math.min(k, m), e, 0, null, !1, !1, !1, !1), 0 < S && (b.beginPath(), b.lineWidth = S, b.moveTo(t + $ / 2, p - ga), b.lineTo(t - $ / 2, p - ga), b.stroke(), b.moveTo(t + $ / 2, h + ga), b.lineTo(t - $ / 2, h + ga), b.stroke()));
                                (x[l].indexLabel || y.indexLabel || x[l].indexLabelFormatter || y.indexLabelFormatter) &&
                                this._indexLabels.push({
                                    chartType: y.type,
                                    dataPoint: x[l],
                                    dataSeries: y,
        ...
        n.prototype.renderRangeColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    l, t, h, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth :
                    1;
                    ...
                    if (0 < g.length)
                        for (var r =
                            ...
                            if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
                                ...
                                var n = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + m) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount +
                                        m) * k << 0,
                                ...
                                Y(c, a.axisX.reversed ? ba : n, l, a.axisX.reversed ? n : ba, t, b, 0, b, r, r, !1, !1, q.fillOpacity);
                                b = X(u);
                                w && Y(this._eventManager.ghostCtx, a.axisX.reversed ? ba : n, l, a.axisX.reversed ? n : ba, t, b, 0, null, !1, !1, !1, !1);
        ...
        n.prototype.renderError = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    l = this.plotArea,
                    t = 0,
                    h, k, m, p, q, g, r, n = a.axisX.dataInfo.minDiff;
                ...
                for (var ba = 0, u = 0; u < this.data.length; u++) !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && ba || ba++;
                for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                    var x = a.dataSeriesIndexes[y],
                        z = this.data[x],
                        v = z.dataPoints,
                        D = s(z._linkedSeries) ? !1 : z._linkedSeries.type.match(/(bar|column)/ig) && z._linkedSeries.visible ? !0 : !1,
                        A = 0;
                    if (D)
                    ...
                    f &&
                        (t = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (D ? ba : 1))) << 0 : 0.03 * this.width);
                    u = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) : Math.abs(n) / Math.abs(a.axisX.range)) / (D ? ba : 1)) << 0;
                    ...
                    !this.dataPointMaxWidth && (this.dataPointMinWidth &&
                        t < e) && (t = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e));
                    u < e && (u = e);
                    u > t && (u = t);
                    if (0 < v.length)
                        for (var E = z._colorSet, t = 0; t < v.length; t++) {
                            var e = z.lineColor = z.options.color ? z.options.color : E[0],
                                L = {
                                    color: v[t].whiskerColor ? v[t].whiskerColor : v[t].color ? z.whiskerColor ? z.whiskerColor : v[t].color : z.whiskerColor ? z.whiskerColor : e,
                                    thickness: s(v[t].whiskerThickness) ? z.whiskerThickness : v[t].whiskerThickness,
                                    dashType: v[t].whiskerDashType ? v[t].whiskerDashType : z.whiskerDashType,
                                    length: s(v[t].whiskerLength) ?
                                        s(z.options.whiskerLength) ? u : z.options.whiskerLength : v[t].whiskerLength,
                                    trimLength: s(v[t].whiskerLength) ? s(z.options.whiskerLength) ? 50 : 0 : 0
                                };
                            ...
                            var S = {
                                color: v[t].stemColor ? v[t].stemColor : v[t].color ? z.stemColor ? z.stemColor : v[t].color : z.stemColor ? z.stemColor : e,
                                thickness: v[t].stemThickness ?
                                    v[t].stemThickness : z.stemThickness,
                                dashType: v[t].stemDashType ? v[t].stemDashType : z.stemDashType
                            };
                            S.thickness = "number" === typeof S.thickness ? 0 > S.thickness ? 0 : Math.round(S.thickness) : 2;
                            v[t].getTime ? r = v[t].x.getTime() : r = v[t].x;
                            if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(v[t].y) && v[t].y.length && "number" === typeof v[t].y[0] && "number" === typeof v[t].y[1]) {
                                ...
                                b ? p = ea : g = ea;
                                b ? (q = a.axisX.reversed ? k + (D ? ba : 1) * u / 2 - (D ? A - 1 : 0) * u << 0 : k - (D ? ba : 1) * u / 2 + (D ? A - 1 : 0) * u << 0, g = a.axisX.reversed ? q - u << 0 : q + u << 0) : (m = a.axisX.reversed ? h + (D ? ba : 1) * u / 2 - (D ? A - 1 : 0) * u << 0 : h - (D ? ba : 1) * u / 2 + (D ? A - 1 : 0) * u << 0, p = a.axisX.reversed ? m - u << 0 : m + u << 0);
                                !b && q > g && (ea = q, q = g, g = ea);
                                b && m > p && (ea = m, m = p, p = ea);
                                ea = z.dataPointIds[t];
                                ...
                                B(c, Math.min(m, p), Math.min(q, g), Math.max(p, m), Math.max(g, q), e, L, S, b);
                                ...
                                if (v[t].indexLabel || z.indexLabel || v[t].indexLabelFormatter || z.indexLabelFormatter) this._indexLabels.push({
                                    ...
                                    indexKeyword: 1,
                                    point: {
                                        x: b ? v[t].y[1] >= v[t].y[0] ? p : m : m + (p - m) / 2,
                ...
                w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas,
                    0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(l.x1, l.y1, l.width, l.height), this._eventManager.ghostCtx.restore());
                c.restore();
                return {
                    source: d,
                    dest: this.plotArea.ctx,
        ...
        n.prototype.renderRangeBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                m = this.options.dataPointWidth ?
                    this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
                this.dataPointMaxWidth && f > l && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, l));
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < r.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (f = 0; f < r.length; f++)
                            if (r[f].getTime ? k = r[f].x.getTime() : k = r[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(r[f].y) && r[f].y.length && "number" === typeof r[f].y[0] &&
                                ...
                                h = a.axisX.reversed ? h + a.plotType.totalDataSeries * m / 2 - (a.previousDataSeriesCount + p) * m << 0 : h - a.plotType.totalDataSeries * m / 2 + (a.previousDataSeriesCount + p) * m << 0;
                                var v = a.axisX.reversed ? h - m << 0 : h + m << 0;
                                l > t && (b = l, l = t, t = b);
                                b = r[f].color ? r[f].color : g._colorSet[f % g._colorSet.length];
                                Y(c, l, a.axisX.reversed ? v : h, t, a.axisX.reversed ? h : v, b, 0, null, n, !1, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
        ...
        n.prototype.renderRangeArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                        ...
                        for (var L = !0; g < p.length; g++)
                            if (u = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !L)))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    q || L ? (m.connectNullData && !q ? (b.setLineDash && (m.options.nullDataLineDashType || D === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = E, D = m.nullDataLineDashType, b.setLineDash(B)), b.lineTo(r, s), w && e.lineTo(r, s), h.push({
                                        x: r,
                                        y1: s,
                                        y2: n
                                    })) : (b.beginPath(), b.moveTo(r, s), y = {
                                        x: r,
                                        y: s
                                    }, h = [], h.push({
                                        x: r,
                                        y1: s,
                                        y2: n
                                    }), w && (e.beginPath(), e.moveTo(r, s))), L = q = !1) : (b.lineTo(r, s), h.push({
                                        x: r,
                                        y1: s,
                                        y2: n
                                    }), w && e.lineTo(r, s), 0 == g % 250 && d());
                                    u = m.dataPointIds[g];
                                    this._eventManager.objectMap[u] = {
                                        id: u,
                                        objectType: "dataPoint",
                                    ...
                                    g < p.length - 1 && (A !== (p[g].lineColor || v) || D !== (p[g].lineDashType || m.lineDashType)) && (d(), A = p[g].lineColor || v, h[h.length - 1].newStrokeStyle = A, b.strokeStyle = A, b.setLineDash && (p[g].lineDashType ? (D = p[g].lineDashType, h[h.length - 1].newLineDashArray = J(D, m.lineThickness), b.setLineDash(h[h.length - 1].newLineDashArray)) : (D = m.lineDashType, h[h.length - 1].newLineDashArray = E, b.setLineDash(E))));
                                    if (0 !== p[g].markerSize && (0 < p[g].markerSize ||
                                            0 < m.markerSize)) {
                                    ...
                                    if (p[g].indexLabel || m.indexLabel || p[g].indexLabelFormatter || m.indexLabelFormatter) this._indexLabels.push({
                                        chartType: "rangeArea",
                                        dataPoint: p[g],
                                        dataSeries: m,
                                        indexKeyword: 0,
                ...
                w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas &&
                    b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(l.x1, l.y1, l.width, l.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        n.prototype.renderRangeSplineArea = function(a) {
            function d(a, c) {
                ...
                if (0 < d.length) {
                    ...
                    for (f = 0; f < d.length - 3; f += 3) b.bezierCurveTo(d[f +
                        1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y), w && e.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y);
                    d = v(ba, 2);
                    ...
                    if (0 < k.lineThickness) {
                        ...
                        for (var g = f = 0; f < d.length - 3; f += 3, g++) {
                            if (n[g].newStrokeStyle || n[g].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), n[g].newStrokeStyle && (b.strokeStyle = n[g].newStrokeStyle), n[g].newLineDashArray && b.setLineDash(n[g].newLineDashArray);
                            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
                        }
                        d = v(n, 2);
                        b.moveTo(d[0].x, d[0].y);
                        for (g = f = 0; f < d.length - 3; f += 3, g++) {
                            if (n[g].newStrokeStyle || n[g].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x,
                                d[f].y), n[g].newStrokeStyle && (b.strokeStyle = n[g].newStrokeStyle), n[g].newLineDashArray && b.setLineDash(n[g].newLineDashArray);
                            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
                        }
                        b.stroke()
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                b.rect(l.x1, l.y1, l.width, l.height);
                b.clip();
                w && (e.beginPath(), e.rect(l.x1, l.y1, l.width,
                    l.height), e.clip());
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                        ...
                        for (g = !1; p < m.length; p++)
                            if (q = m[p].x.getTime ? m[p].x.getTime() : m[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))
                                if (null !== m[p].y && m[p].y.length && "number" === typeof m[p].y[0] && "number" === typeof m[p].y[1]) {
                                    ...
                                    p < m.length - 1 && (x !== (m[p].lineColor || y) || z !== (m[p].lineDashType || k.lineDashType)) && (x = m[p].lineColor || y, n[n.length - 1].newStrokeStyle = x, b.setLineDash && (m[p].lineDashType ? (z = m[p].lineDashType, n[n.length - 1].newLineDashArray = J(z, k.lineThickness)) : (z = k.lineDashType, n[n.length - 1].newLineDashArray = A)));
                                    ...
                                    g = !1
                                } else 0 < p && !g && (k.connectNullData ? b.setLineDash && (0 < n.length && (k.options.nullDataLineDashType || !m[p - 1].lineDashType)) && (n[n.length - 1].newLineDashArray = D, z = k.nullDataLineDashType) : (d(A, y), n = [], ba = [])), g = !0;
                        d(A, y);
                        W.drawMarkers(f)
                    }
                }
                w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0,
                    this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(l.x1, l.y1, l.width, l.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        n.prototype.renderWaterfall = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx,
                    ...
                    f = this.plotArea,
                    l = 0,
                    h, s, k, m, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    l = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                s = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0;
                var q =
                ...
                this.dataPointMaxWidth && l > s && (l = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, s));
                !this.dataPointMaxWidth && (this.dataPointMinWidth && s < l) && (s = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, l));
                q < l && (q = l);
                q > s && (q = s);
                c.save();
                w && this._eventManager.ghostCtx.save();
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    n.fallingColor = n.options.fallingColor ? n.options.fallingColor : "#e40a0a";
                    var u = "number" === typeof n.options.lineThickness ? Math.round(n.lineThickness) : 1,
                        y = 1 === Math.round(u) % 2 ? -0.5 : 0;
                    if (0 < v.length)
                        for (var x = 5 < q && n.bevelEnabled ? !0 : !1, z = !1, A = null, D = null, l = 0; l < v.length; l++)
                            if (v[l].getTime ? m = v[l].x.getTime() : m = v[l].x, "number" !== typeof v[l].y) {
                                if (0 < l && !z && n.connectNullData) var B = n.options.nullDataLineDashType || !v[l - 1].lineDashType ? n.nullDataLineDashType : v[l - 1].lineDashType;
                                z = !0
                            } else {
                                h = a.axisX.convertValueToPixel(m);
                                s = 0 === n.dataPointEOs[l].cumulativeSum ? p : a.axisY.convertValueToPixel(n.dataPointEOs[l].cumulativeSum);
                                ...
                                var L = v[l].color ? v[l].color : 0 < v[l].y ? n.risingColor : n.fallingColor;
                                Y(c, a.axisX.reversed ? E : h, a.axisY.reversed ? k : s, a.axisX.reversed ? h : E, a.axisY.reversed ? s : k, L, 0, L, x, x, !1, !1, n.fillOpacity);
                                e = X(e);
                                w && Y(this._eventManager.ghostCtx, a.axisX.reversed ? E : h, s, a.axisX.reversed ? h : E, k, e, 0, null, !1, !1, !1, !1);
                                var S, L = h;
                                S = "undefined" !== typeof v[l].isIntermediateSum && !0 === v[l].isIntermediateSum || "undefined" !== typeof v[l].isCumulativeSum && !0 === v[l].isCumulativeSum ? 0 < v[l].y ? s : k : 0 < v[l].y ? k : s;
                                0 < l && A && (!z || n.connectNullData) &&
                                    (z && c.setLineDash && c.setLineDash(J(B, u)), c.beginPath(), c.moveTo(A, D - y), c.lineTo(L, S - y), 0 < u && c.stroke(), w && (b.beginPath(), b.moveTo(A, D - y), b.lineTo(L, S - y), 0 < u && b.stroke()));
                                z = !1;
                                A = E;
                                D = 0 < v[l].y ? s : k;
                                L = v[l].lineDashType ? v[l].lineDashType : n.options.lineDashType ? n.options.lineDashType : "shortDash";
                                c.strokeStyle = v[l].lineColor ? v[l].lineColor : n.options.lineColor ? n.options.lineColor : "#9e9e9e";
                                c.lineWidth = u;
                                c.setLineDash && (L = J(L, u), c.setLineDash(L));
                                (v[l].indexLabel || n.indexLabel || v[l].indexLabelFormatter || n.indexLabelFormatter) &&
                                this._indexLabels.push({
                                    chartType: "waterfall",
                                    dataPoint: v[l],
                                    dataSeries: n,
                ...
                w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx &&
                    this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(f.x1, f.y1, f.width, f.height), this._eventManager.ghostCtx.restore());
                c.restore();
                return {
                    source: d,
                    dest: this.plotArea.ctx,
        ...
        var pa = function(a, d, c, b, e, f, l, h, s) {
            if (!(0 > c)) {
                ...
                a.save();
                a.globalAlpha = h;
                "pie" === e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, f, l, !1), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, l, !1), 0 <= s && a.arc(d.x, d.y, s * c, l, f, !0), a.closePath(), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
                a.globalAlpha = 1;
                a.restore()
            }
        };
        n.prototype.renderPie = function(a) {
            function d() {
                if (k && m) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
                        ...
                        if (k.indexLabelFormatter || f.indexLabelFormatter) t = {
                            chart: n.options,
                            dataSeries: k,
                            dataPoint: f,
                            total: p.total,
                        ...
                        p = f.indexLabelFormatter ? f.indexLabelFormatter(t) : f.indexLabel ? n.replaceKeywordsWithValue(f.indexLabel, f, k, e) : k.indexLabelFormatter ? k.indexLabelFormatter(t) : k.indexLabel ? n.replaceKeywordsWithValue(k.indexLabel, f, k, e) : f.label ? f.label : "";
                        n._eventManager.objectMap[l] =
                            h;
                        h.center = {
                            x: x.x,
                            y: x.y
                        ...
                        h.indexLabelFontSize = s(f.indexLabelFontSize) ? k.indexLabelFontSize : f.indexLabelFontSize;
                        ...
                        h.indexLabelBackgroundColor = f.indexLabelBackgroundColor ?
                            f.indexLabelBackgroundColor : k.options.indexLabelBackgroundColor ? k.options.indexLabelBackgroundColor : k.indexLabelBackgroundColor;
                        ...
                        h.startAngle = 0 === e ? k.startAngle ? k.startAngle / 180 *
                            Math.PI : 0 : g[e - 1].endAngle;
                    ...
                    l = f = 0;
                    p = !1;
                    for (e = 0; e < m.length; e++) h = g[(c + e) % m.length], 1 < a && (h.midAngle > Math.PI / 2 - u && h.midAngle < Math.PI /
                        2 + u) && (f <= a / 2 && !p ? (h.hemisphere = "right", f++) : (h.hemisphere = "left", p = !0));
                    p = !1;
                    for (e = 0; e < m.length; e++) h = g[(d + e) % m.length], 1 < b && (h.midAngle > 3 * Math.PI / 2 - u && h.midAngle < 3 * Math.PI / 2 + u) && (l <= b / 2 && !p ? (h.hemisphere = "left", l++) : (h.hemisphere = "right", p = !0))
                }
            }
                ...
                for (b = 0; b < m.length; b++) {
                    ...
                    if (d > c) {
                        var e = 0.07 * D * Math.cos(g[b].midAngle),
                            f =
                            0.07 * D * Math.sin(g[b].midAngle),
                            l = !1;
                        if (m[b].exploded) {
                            if (1E-9 < Math.abs(g[b].center.x - (x.x + e)) || 1E-9 < Math.abs(g[b].center.y - (x.y + f))) g[b].center.x = x.x + e * a, g[b].center.y = x.y + f * a, l = !0
                        } else if (0 < Math.abs(g[b].center.x - x.x) || 0 < Math.abs(g[b].center.y - x.y)) g[b].center.x = x.x + e * (1 - a), g[b].center.y = x.y + f * (1 - a), l = !0;
                        l && (e = {}, e.dataSeries = k, e.dataPoint = k.dataPoints[b], e.index = b, n.toolTip.highlightObjects([e]));
                        pa(n.plotArea.ctx, g[b].center, g[b].radius, m[b].color ? m[b].color : k._colorSet[b % k._colorSet.length], k.type,
                            c, d, k.fillOpacity, g[b].percentInnerRadius)
                    }
                }
                a = n.plotArea.ctx;
                a.save();
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < m.length) {
                    var p = g[a];
                    if (0 > c && p.indexLabelTextBlock.y < l || 0 < c && p.indexLabelTextBlock.y > h) return 0;
                    var q = 0,
                        t = 0,
                        t = q = q = 0;
                    0 > c ? p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 > l &&
                        p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 + c < l && (c = -(l - (p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 + c))) : p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 < l && p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 + c > h && (c = p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 + c - h);
                    c = p.indexLabelTextBlock.y + c;
                    l = 0;
                    l = "right" === p.hemisphere ? x.x + Math.sqrt(Math.pow(w, 2) - Math.pow(c - x.y, 2)) : x.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - x.y, 2));
                    ...
                    for (h = 1; h < m.length; h++)
                        if (l = (a - h + g.length) % g.length, g[l].hemisphere !== g[a].hemisphere) {
                            l = null;
                            break
                        } else if (g[l].indexLabelText && g[l].hemisphere === g[a].hemisphere && l !== a && (0 > b(g[l], g[a]) || ("right" === g[a].hemisphere ? g[l].indexLabelTextBlock.y <= g[a].indexLabelTextBlock.y : g[l].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y))) break;
                    else l = null;
                    t = l;
                    q = e(a);
                    h = l = 0;
            ...
            function l() {
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    if (k.radius || !k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius && D - d <= B) l = !1;
                    l && (D -= d);
                    d = 0;
                        ...
                        for (var t, s, a = 0; a < m.length; a++) {
                            ...
                            if (null !== u) {
                                ...
                                var z = 0,
                                    z = b(t, s) - r;
                                if (0 > z) {
                                    for (var A = s = 0, H = 0; H < m.length; H++) H !== a && g[H].hemisphere === h.hemisphere && (g[H].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? s++ : A++);
                                    s = z / (s + A || 1) * A;
                                    var A = -1 * (z - s),
                                        J = H = 0;
                                    "right" === h.hemisphere ? (H = f(a, s), A = -1 * (z - H), J = f(u, A), +J.toFixed(y) < +A.toFixed(y) && +H.toFixed(y) <= +s.toFixed(y) && f(a, -(A - J))) : (H = f(u, s), A = -1 * (z - H), J = f(a, A), +J.toFixed(y) < +A.toFixed(y) && +H.toFixed(y) <= +s.toFixed(y) && f(u, -(A - J)))
                                }
                            }
                        }
                    } else
                        for (a = 0; a < m.length; a++) h = g[a], w = "pie" === k.type ?
                            0.7 * D : 0.85 * D, u = x.x + w * Math.cos(h.midAngle), s = x.y + w * Math.sin(h.midAngle), h.indexLabelTextBlock.x = u, h.indexLabelTextBlock.y = s;
                    for (a = 0; a < m.length; a++)
                        if (h = g[a], u = h.indexLabelTextBlock.measureText(), 0 !== u.height && 0 !== u.width) u = u = 0, "right" === h.hemisphere ? (u = q.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + p), u *= -1) : u = q.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - p), 0 < u && (!l && h.indexLabelText && (s = "right" === h.hemisphere ? q.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - q.x1, 0.3 * h.indexLabelTextBlock.maxWidth >
                            ...
                            (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5), 0 < u && (!l && h.indexLabelText && (s = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1, 0 === f(a, u * s) && f(a, 2 * s)), Math.abs(h.indexLabelTextBlock.x - x.x) < D && (u /= Math.abs(Math.sin(h.indexLabelAngle)), 9 < u && (u *= 0.3), u > d && (d = u)));
                    var G = function(a, b, c) {
                        for (var d = [], e = 0; d.push(g[b]), b !== c; b = (b + 1 + m.length) % m.length);
                        d.sort(function(a, b) {
                            return a.y - b.y
                        });
                        for (b = 0; b < d.length; b++)
                            if (c = d[b], e < 0.7 * a) e += c.indexLabelTextBlock.height, c.indexLabelTextBlock.text = "",
                                ...
                                if (null !== k) {
                                    ...
                                    if (q = 0 > z) {
                                        ...
                                        var n = t.indexLabelTextBlock.y - t.indexLabelTextBlock.height / 2,
                                            ...
                                            C = h.indexLabelTextBlock.y +
                                            h.indexLabelTextBlock.height / 2;
                                        q = t.indexLabelTextBlock.x + t.indexLabelTextBlock.width < h.indexLabelTextBlock.x - p || q > u + p || n > C + p || r < s - p ? !1 : !0
                                    }
                                    q ? (0 > a && (a = l), k !== a && (c = k, d += -z), 0 === l % Math.max(m.length / 10, 3) && (f = !0)) : f = !0;
            ...
            function h() {
                ...
                n.legend && (n.legend.dockInsidePlotArea || "center" === n.legend.horizontalAlign && "center" === n.legend.verticalAlign) && (n.legend.setLayout(), n.legend.render())
            }
            var n = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var k = this.data[a.dataSeriesIndexes[0]],
                    ...
                    z = 0;
                a = !1;
                for (var A = 0; A < m.length; A++) z +=
                    Math.abs(m[A].y), !a && ("undefined" !== typeof m[A].indexLabel && null !== m[A].indexLabel && 0 < m[A].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof m[A].label && null !== m[A].label && 0 < m[A].label.toString().length) && (a = !0);
                if (0 !== z) {
                    ...
                    var B = "undefined" !== typeof k.innerRadius &&
                        null !== k.innerRadius ? Ta(k.innerRadius, D) : 0.7 * D;
                    k.radius = D;
                    "doughnut" === k.type && (k.innerRadius = B);
                    var E = Math.min(B / D, (D - 1) / D);
                    this.pieDoughnutClickHandler = function(a) {
                        n.isAnimating || !s(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && n._animator.animate(0, 500, function(a) {
                            c(a);
                            h();
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                        ...
                        for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < m.length; c++) {
                            var d = 0 === c ? g[c].startAngle : e,
                                ...
                                f = !1;
                            e > b && (e = b, f = !0);
                            var l = m[c].color ? m[c].color : k._colorSet[c % k._colorSet.length];
                            e > d && pa(n.plotArea.ctx, g[c].center, g[c].radius, l, k.type, d, e, k.fillOpacity, g[c].percentInnerRadius);
                            if (f) break
                        }
                        h();
                        n.dispatchEvent("dataAnimationIterationEnd", {
        ...
        var ra = function(a, d, c, b) {
            ...
            0 >= Math.round(d.y4 - d.y1) || (a.save(), a.globalAlpha = c, a.beginPath(), a.moveTo(Math.round(d.x1), Math.round(d.y1)), a.lineTo(Math.round(d.x2),
        ...
        n.prototype.renderFunnel = function(a) {
            function d() {
                ...
                if (0 === a) return -1;
                for (c =
                    b[0] = 0; c < y.length; c++) b.push(Math.abs(y[c].y) * E / a);
                return b
            }
            ...
            function c() {
                ...
                if (0 === g) return -1;
                for (var k = d[0] = 0, h = 0, m, p, b = b - a, k = !1, l = 0; l < y.length; l++) a = Math.abs(y[l].y) * f / g, k ? m = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = aa * aa * b * b - 4 * Math.abs(aa) * a, 0 > p ? (p = c, k = (b + p) * (e - h) /
                    2, a -= k, m = e - h, h += e - h, m += 0 == p ? 0 : a / p, h += a / p, k = !0) : (m = (Math.abs(aa) * b - Math.sqrt(p)) / 2, p = b - 2 * m / Math.abs(aa), h += m, h > e && (h -= m, p = c, k = (b + p) * (e - h) / 2, a -= k, m = e - h, h += e - h, m += a / p, h += a / p, k = !0), b = p)), d.push(m);
                return d
            }

            function b() {
                if (u && y) {
                    for (var a, b, c, d, e, f, l, k, h, m, p, q, t, n, r, C = [], x = [], v = {
                            percent: null,
                            total: null
                        }, z = null, D = 0; D < y.length; D++) r = R[D], r = "undefined" !== typeof r.x5 ? (r.y2 + r.y4) / 2 : (r.y2 + r.y3) / 2, r = g(r).x2 + 1, C[D] = K - r - X;
                    r = 0.5 * X;
                    for (var D = 0, B = y.length - 1; D < y.length || 0 <= B; D++, B--) {
                        b = u.reversed ? y[B] : y[D];
                        a = b.color ?
                            b.color : u.reversed ? u._colorSet[(y.length - 1 - D) % u._colorSet.length] : u._colorSet[D % u._colorSet.length];
                        ...
                        k = b.indexLabelFontFamily ||
                            u.indexLabelFontFamily || "arial";
                        ...
                        "inside" === u.indexLabelPlacement && (C[D] = D !== ca ? u.reversed ? R[D].x2 - R[D].x1 : R[D].x3 - R[D].x4 : R[D].x3 - R[D].x6, 20 > C[D] && (C[D] = D !== ca ? u.reversed ? R[D].x3 - R[D].x4 : R[D].x2 - R[D].x1 : R[D].x2 - R[D].x1, C[D] /= 2));
                        t = b.indexLabelMaxWidth ? b.indexLabelMaxWidth : u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth : C[D];
                        if (t > C[D] || 0 > t) t = C[D];
                        x[D] = "inside" === u.indexLabelPlacement ? R[D].height : !1;
                        v = A.getPercentAndTotal(u,
                            b);
                        ...
                        b = b.indexLabelFormatter ? b.indexLabelFormatter(z) : b.indexLabel ? A.replaceKeywordsWithValue(b.indexLabel, b, u, D) : u.indexLabelFormatter ? u.indexLabelFormatter(z) : u.indexLabel ? A.replaceKeywordsWithValue(u.indexLabel, b, u, D) : b.label ? b.label : "";
                        0 >= m && (m = 0);
            ...
            function e() {
                ...
                e = !1;
                c = 0;
                for (var g, l = K - V - X / 2, l = u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth > l ? l : u.indexLabelMaxWidth : l, k = I.length - 1; 0 <= k; k--) {
                    g = y[I[k].id];
                    c = I[k];
                    d = c.textBlock;
                ...
                if (e)
                    for (k = I.length - 1; 0 <= k; k--) a = R[k], I[k].textBlock.maxWidth = f[f.length - (k + 1)], I[k].textBlock.measureText(), I[k].textBlock.x = K - l, c = I[k].textBlock.height < I[k].textBlock.maxHeight ? I[k].textBlock.height : I[k].textBlock.maxHeight, e = I[k].textBlock.width < I[k].textBlock.maxWidth ? I[k].textBlock.width : I[k].textBlock.maxWidth, I[k].height = c, I[k].width = e, c = "undefined" !== typeof a.x5 ?
                        (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, I[k].textBlock.y = c - I[k].height / 2, u.reversed ? (I[k].textBlock.y + I[k].height > U + z && (I[k].textBlock.y = U + z - I[k].height), I[k].textBlock.y < ta - z && (I[k].textBlock.y = ta - z)) : (I[k].textBlock.y < U - z && (I[k].textBlock.y = U - z), I[k].textBlock.y + I[k].height > ta + z && (I[k].textBlock.y = ta + z - I[k].height))
            }

            function f() {
                var a, b, c, d;
                if ("inside" !== u.indexLabelPlacement)
                    for (var e = 0; e < R.length; e++) 0 == I[e].textBlock.text.length ? I[e].isDirty = !0 : (a = R[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) /
                        2, b = u.reversed ? "undefined" !== typeof a.x5 ? c > Ca ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < Ca ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, I[e].textBlock.x = b + X, I[e].textBlock.y = c - I[e].height / 2, u.reversed ? (I[e].textBlock.y + I[e].height > U + z && (I[e].textBlock.y = U + z - I[e].height), I[e].textBlock.y < ta - z && (I[e].textBlock.y = ta - z)) : (I[e].textBlock.y < U - z && (I[e].textBlock.y = U - z), I[e].textBlock.y + I[e].height > ta + z && (I[e].textBlock.y = ta + z - I[e].height)));
                else
                    for (e = 0; e < R.length; e++) 0 == I[e].textBlock.text.length ?
                        I[e].isDirty = !0 : (a = R[e], b = a.height, c = I[e].height, d = I[e].width, b >= c ? (b = e != ca ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2, c = e != ca ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, I[e].textBlock.x = b, I[e].textBlock.y = c) : I[e].isDirty = !0)
            }
            ...
            function l() {
                ...
                function b() {
                    ...
                    for (var k, h = 1; h < l; h++) {
                        e = h * f;
                        for (var t = I.length - 1; 0 <= t; t--) !I[t].isDirty && (I[t].textBlock.y < e && I[t].textBlock.y + I[t].height > e) && (k = q(t), !(k >= I.length - 1) && I[t].textBlock.y + I[t].height + da > I[k].textBlock.y && (I[t].textBlock.y = I[t].textBlock.y + I[t].height - e > e - I[t].textBlock.y ? e + 1 : e - I[t].height - 1))
                    }
                        ...
                        if (!I[k].isDirty) {
                            ...
                            if (I[k].textBlock.y < I[e].textBlock.y + I[e].height) {
                                d =
                                    d || k;
                                f = k;
                                for (l = 0; I[f].textBlock.y < I[e].textBlock.y + I[e].height + da;) {
                ...
                function c(a, b, d) {
                    ...
                    for (d = 0; d < e.length; d++)
                        if (b = e[d], f < a) g++, f += I[b.id].height + da, I[b.id].textBlock.text = "", I[b.id].indexLabelText =
                            "", I[b.id].isDirty = !0, I[b.id].textBlock.measureText();
                        else break;
                    return g
                }
                for (var d, e, f, g, l, k, m = 1, r = 0; r < 2 * m; r++) {
                    for (var n = I.length - 1; 0 <= n && !(0 <= p(n) && p(n), f = I[n], g = f.textBlock, k = (l = q(n) < R.length ? I[q(n)] : null) ? l.textBlock : null, d = +f.height.toFixed(6), e = +g.y.toFixed(6), !f.isDirty && (l && e + d + da > +k.y.toFixed(6)) && (d = g.y + d + da - k.y, e = a(n, -d), e < d && (0 < e && (d -= e), e = a(q(n), d), e != d))); n--);
                    b()
                }
            }

            function h(a, b) {
                return (b < R.length ? I[b].textBlock.y : u.reversed ? U + z : ta + z) - (0 > a ? u.reversed ? ta - z : U - z : I[a].textBlock.y + I[a].height +
                    da)
            }
            ...
            function n(a, b, c) {
                var d, e, g, l = [],
                    h = z,
                    p = []; - 1 !== b && (0 <= Z.indexOf(b) ? (e = Z.indexOf(b), Z.splice(e, 1)) : (Z.push(b), Z = Z.sort(function(a, b) {
                    return a - b
                })));
                if (0 === Z.length) l = ia;
                else {
                ...
                var t = {
                    ...
                    changeSection: function(a) {
                        for (var b, c, d = 0; d < R.length; d++) b = g[d], c = R[d], b *= a, "undefined" === typeof p[d] && (p[d] = 0), 0 > p && (p *= -1), c.y1 += b - p[d], c.y2 += b - p[d], c.y3 += b - p[d], c.y4 += b - p[d], c.y5 && (c.y5 += b - p[d], c.y6 += b - p[d]), p[d] = b
                    }
                };
            ...
            function m(a) {
                for (var b, c, d, e, f = 0; f < R.length; f++) e = 1 === I[f].lineThickness % 2 ? 0.5 : 0, c = ((R[f].y2 + R[f].y4) /
                    2 << 0) + e, b = g(c).x2 - 1, d = I[f].textBlock.x, e = (I[f].textBlock.y + I[f].height / 2 << 0) + e, I[f].isDirty || 0 == I[f].lineThickness || (a.strokeStyle = I[f].lineColor, a.lineWidth = I[f].lineThickness, a.setLineDash && a.setLineDash(J(I[f].lineDashType, I[f].lineThickness)), a.beginPath(), a.moveTo(b, c), a.lineTo(d, e), a.stroke())
            }
            ...
            function r(a) {
                for (var b = 0; b < R.length; b++) I[b].isDirty || (a && (I[b].textBlock.ctx = a), I[b].textBlock.render(!0))
            }
            ...
            function v(a) {
                ...
                if (A.subtitles)
                    for (var b =
                            0; b < A.subtitles.length; b++) {
                        var c = A.subtitles[b];
                        if (c.dockInsidePlotArea || "center" === c.horizontalAlign && "center" === c.verticalAlign) A.subtitles.ctx = a, c.render()
                    }
            ...
            var A = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, x = this.plotArea, z = 0.025 * x.width, B = 0.01 * x.width,
                        D = 0, E = x.height - 2 * z, G = Math.min(x.width - 2 * B, 2.8 * x.height), L = !1, S = 0; S < y.length; S++)
                    if (!L && ("undefined" !== typeof y[S].indexLabel && null !== y[S].indexLabel && 0 < y[S].indexLabel.toString().length) && (L = !0), !L && ("undefined" !== typeof y[S].label && null !== y[S].label && 0 < y[S].label.toString().length) && (L = !0), !L && "function" === typeof u.indexLabelFormatter || "function" === typeof y[S].indexLabelFormatter) L = !0;
                L = L || "undefined" !== typeof u.indexLabel && null !== u.indexLabel && 0 < u.indexLabel.toString().length;
                "inside" !== u.indexLabelPlacement &&
                    L || (B = (x.width - 0.75 * G) / 2);
                var S = x.x1 + B,
                    K = x.x2 - B,
                    $ = x.y1 + z,
                    N = x.y2 - z,
                ...
                if (0 != u.length && (u.dataPoints && u.visible) && 0 !== y.length) {
                    ...
                    a = 75 * G / 100;
                    var X = 30 * (K - a) / 100;
                    "funnel" === u.type ? (Q = s(u.options.neckHeight) ? 0.35 * E : u.neckHeight, F = s(u.options.neckWidth) ? 0.25 * a : u.neckWidth, "string" === typeof Q && Q.match(/%$/) ? (Q = parseInt(Q), Q = Q * E / 100) : Q = parseInt(Q), "string" === typeof F && F.match(/%$/) ? (F = parseInt(F), F = F * a / 100) : F = parseInt(F), Q > E ? Q = E : 0 >= Q && (Q = 0), F > a ? F = a - 0.5 :
                        0 >= F && (F = 0)) : "pyramid" === u.type && (F = Q = 0, u.reversed = u.reversed ? !1 : !0);
                    var B = S + a / 2,
                        T = S,
                        V = S + a,
                        U = u.reversed ? N : $,
                    ...
                    if (-1 !== S) {
                        if (u.reversed)
                            for (G.push(Y), F = S.length - 1; 0 < F; F--) Y += S[F], G.push(Y);
                        else
                            for (F = 0; F < S.length; F++) Y += S[F], G.push(Y);
                        if (u.reversed)
                            for (F = 0; F < S.length; F++) G[F] < Ca ? (a.push(O), B.push(W), ca = F) : (a.push((G[F] - U + aa * T) /
                                aa), B.push((G[F] - U + fa * V) / fa));
                        else
                            for (F = 0; F < S.length; F++) G[F] < Ca ? (a.push((G[F] - U + aa * T) / aa), B.push((G[F] - U + fa * V) / fa), ca = F) : (a.push(O), B.push(W));
                        for (F = 0; F < S.length - 1; F++) Y = u.reversed ? y[y.length - 1 - F].color ? y[y.length - 1 - F].color : u._colorSet[(y.length - 1 - F) % u._colorSet.length] : y[F].color ? y[F].color : u._colorSet[F % u._colorSet.length], F === ca ? R.push({
                            x1: a[F],
                            y1: G[F],
                            x2: B[F],
                            y2: G[F],
                        ...
                        if (L && u.visible && (b(), f(), e(), "inside" !== u.indexLabelPlacement)) {
                            l();
                            for (F = 0; F < y.length; F++) I[F].isDirty || (a = I[F].textBlock.x + I[F].width, a = (K - a) / 2, 0 == F && (D = a), D > a && (D = a));
                            for (F =
                                0; F < R.length; F++) R[F].x1 += D, R[F].x2 += D, R[F].x3 += D, R[F].x4 += D, R[F].x5 && (R[F].x5 += D, R[F].x6 += D), I[F].textBlock.x += D
                        }
                        for (F = 0; F < R.length; F++) D = R[F], ra(P, D, u.fillOpacity), ia.push(D.y1);
                        v(P);
                        L && u.visible && ("inside" === u.indexLabelPlacement || A.animationEnabled || m(P), A.animationEnabled || r());
                        if (!L)
                            for (F = 0; F < y.length; F++) D = u.dataPointIds[F], a = {
                                id: D,
                                objectType: "dataPoint",
                                dataPointIndex: F,
                                dataSeriesIndex: 0,
                        ...
                        !A.animationEnabled && S ? n(A,
                            -1, 0) : A.animationEnabled && !A.animatedRender && n(A, -1, 0);
                        this.funnelPyramidClickHandler = function(a) {
                            var b = -1;
                            if (!ha && !A.isAnimating && (s(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = u.reversed ? y.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) {
                                a = b;
                                if ("funnel" === u.type || "pyramid" === u.type) u.reversed ? y[y.length - 1 - a].exploded = y[y.length - 1 - a].exploded ? !1 : !0 : y[a].exploded = y[a].exploded ? !1 : !0;
                                n(A, b, 500)
                            }
                        };
                        return {
        ...
        n.prototype.exportChart = function(a) {
            ...
            if (b && d && c) {
                ...
                if ("undefined" !== typeof Blob && new Blob) {
                    for (var l = b.replace(/^data:[a-z\/]*;base64,/, ""), l = atob(l), h = new ArrayBuffer(l.length), h = new Uint8Array(h), n = 0; n < l.length; n++) h[n] = l.charCodeAt(n);
                    d = new Blob([h.buffer], {
                        type: "image/" + d
                    });
                    try {
        ...
        n.prototype.replaceKeywordsWithValue =
            function(a, d, c, b, e) {
                var f = this;
                ...
                return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                    ...
                    g = g[a];
                    null !== l && (g = g[l]);
                    return "x" === a ? (c.axisX && "dateTime" === c.axisX.valueType || "dateTime" === c.xValueType || d.x && d.x.getTime) && !c.axisX.logarithmic ?
                        ...
                        "z" === a ? da(g, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########", f._cultureInfo) : g
                })
            };
        oa(K, G);
        K.prototype.setLayout = function() {
            ...
            if ("top" === this.verticalAlign ||
                "bottom" === this.verticalAlign) this.orientation = "horizontal", c = this.verticalAlign, f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, l = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height;
                ...
                l = this.maxHeight = null !== this.maxHeight ? this.maxHeight :
                    d.height
            }
            ...
            for (var m = 0; m < this.dataSeries.length; m++) {
                ...
                if (p.dataPoints && p.dataPoints.length)
                    if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                        var q = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? "error" === p.type && p._linkedSeries ? p._linkedSeries.legendMarkerType ? p._linkedSeries.legendMarkerType : Q.getDefaultLegendMarker(p._linkedSeries.type) :
                            Q.getDefaultLegendMarker(p.type) : p.markerType,
                            ...
                            v = p.legendMarkerBorderColor ? p.legendMarkerBorderColor :
                            p.markerBorderColor,
                        ...
                        for (var y = 0; y < p.dataPoints.length; y++) {
                            var x =
                                ...
                                g = x.legendText ? x.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                                    chart: this.chart,
                                    legend: this.options,
                                    dataSeries: p,
                                    dataPoint: x
                                }) : x.name ? x.name : "DataPoint: " + (y + 1),
                                r = x.legendMarkerColor ? x.legendMarkerColor : p.legendMarkerColor ? p.legendMarkerColor : x.color ? x.color : p.color ? p.color : p._colorSet[y % p._colorSet.length],
                                w = 0.75 * this.lineHeight,
                                v = x.legendMarkerBorderColor ?
                                x.legendMarkerBorderColor : p.legendMarkerBorderColor ? p.legendMarkerBorderColor : x.markerBorderColor ? x.markerBorderColor : p.markerBorderColor,
                                u = x.legendMarkerBorderThickness ? x.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : x.markerBorderThickness || p.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0,
                            ...
                            (x.showInLegend || p.showInLegend && !1 !== x.showInLegend) && n.push(q)
                        }
            ...
            if (0 < n.length) {
                ...
                for (m = 0; m < n.length; m++) {
                    q = n[m];
                    v = x;
                    if ("line" === q.chartType || "spline" === q.chartType ||
                        "stepLine" === q.chartType) v -= 2 * 0.1 * this.lineHeight;
                    if (!(0 >= l || "undefined" === typeof l || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            null !== this.itemWidth && (q.textBlock.width =
                                this.itemWidth - (w + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)));
                            if (!p || p.width + Math.round(q.textBlock.width + w + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) p = {
                                items: [],
                                width: 0
                            ...
                            g = Math.max(g, q.textBlock.height ? q.textBlock.height : this.lineHeight)
                                ...
                                fontStyle: this.fontStyle,
                                textBaseline: "middle"
                            }), q.textBlock.measureText(), null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (w + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < l - this.lineHeight ? (p = {
                                items: [],
                                width: 0
                            }, k.push(p)) : (p = k[y], y = (y + 1) % k.length), this.height +=
                        ...
                        r = q.textBlock.width + (w + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))
                    }
                }
                this.itemWidth = r;
                this.height = !1 === this.itemWrap ? k.length *
                    this.lineHeight : this.height + g;
            ...
            "top" === this.verticalAlign ? (e = "left" === this.horizontalAlign ? d.x1 : "right" === this.horizontalAlign ? d.x2 - this.width : d.x1 + d.width / 2 - this.width / 2, b = d.y1) : "center" === this.verticalAlign ? (e = "left" === this.horizontalAlign ? d.x1 : "right" === this.horizontalAlign ? d.x2 - this.width : d.x1 + d.width / 2 - this.width / 2, b = d.y1 + d.height / 2 - this.height / 2) : "bottom" === this.verticalAlign && (e = "left" === this.horizontalAlign ? d.x1 : "right" ===
                this.horizontalAlign ? d.x2 - this.width : d.x1 + d.width / 2 - this.width / 2, b = d.y2 - this.height);
            this.items = n;
            for (m = 0; m < this.items.length; m++) q = n[m], q.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[q.id] = {
                id: q.id,
            ...
            this.markerSize = w;
            this.rows = k;
            0 < n.length && a.layoutManager.registerSpace(c, {
        ...
        K.prototype.render = function() {
            ...
            for (var h = 0, n = 0; n < l.length; n++) {
                for (var k = l[n], m = 0, p = 0; p < k.items.length; p++) {
                    ...
                    this.ctx.restore();
                    m = 0 < p ? Math.max(m, q.textBlock.height ? q.textBlock.height : this.lineHeight) : q.textBlock.height ?
                        q.textBlock.height : this.lineHeight;
        ...
        Q.prototype.getDefaultAxisPlacement = function() {
            var a = this.type;
            if ("column" === a || "line" === a || "stepLine" === a || "spline" === a || "area" === a || "stepArea" === a || "splineArea" === a || "stackedColumn" === a || "stackedLine" === a || "bubble" === a || "scatter" === a || "stackedArea" === a || "stackedColumn100" === a || "stackedLine100" === a || "stackedArea100" === a || "candlestick" ===
                a || "ohlc" === a || "rangeColumn" === a || "rangeArea" === a || "rangeSplineArea" === a || "boxAndWhisker" === a || "waterfall" === a) return "normal";
        ...
        Q.getDefaultLegendMarker = function(a) {
            if ("column" === a || "stackedColumn" === a || "stackedLine" === a || "bar" === a || "stackedBar" === a || "stackedBar100" === a || "bubble" ===
                a || "scatter" === a || "stackedColumn100" === a || "stackedLine100" === a || "stepArea" === a || "candlestick" === a || "ohlc" === a || "rangeColumn" === a || "rangeBar" === a || "rangeArea" === a || "rangeSplineArea" === a || "boxAndWhisker" === a || "waterfall" === a) return "square";
        ...
        Q.prototype.getDataPointAtX = function(a, d) {
            ...
            var c = {
                ...
                k = 0,
                m = 0;
            "none" !== this.chart.plotInfo.axisPlacement && (this.axisX.logarithmic ? (m = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), m = 1 < m ? Math.min(Math.max((this.dataPoints.length - 1) / m * Math.log(a / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (m = this.dataPoints[this.dataPoints.length -
                1].x - this.dataPoints[0].x, m = 0 < m ? Math.min(Math.max((this.dataPoints.length - 1) / m * (a - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0));
            for (;;) {
                f = 0 < l ? m + e : m - e;
                ...
                } else if (0 > m - e && m + e >= this.dataPoints.length) break; - 1 === l ? (e++, l = 1) : l = -1
            }
            return d || (c.dataPoint.x.getTime ? c.dataPoint.x.getTime() :
                c.dataPoint.x) !== (a.getTime ? a.getTime() : a) ? d && null !== c.dataPoint ? c : null : c
        };
        Q.prototype.getDataPointAtXY = function(a, d, c) {
            ...
            if ("none" !== this.chart.plotInfo.axisPlacement)
                if (p = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({
                        x: a,
                        y: d
                    }), this.axisX.logarithmic) var q =
                    Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "doughnut":
                                ...
                                r < q.radius && r > v && (r = Math.atan2(d - w.y, a - w.x), 0 > r && (r += 2 * Math.PI), r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)), w = Number(((180 * (q.startAngle / Math.PI) % 360 +
                                    360) % 360).toFixed(12)), v = Number(((180 * (q.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === v && 1 < q.endAngle && (v = 360), w >= v && (0 !== g.y && !s(g.y)) && (v += 360, r < w && (r += 360)), r > w && r < v && (b.push({
                                    dataPoint: g,
                                    dataPointIndex: f,
                                    dataSeries: this,
                                    distance: 0
                            ...
                            case "pyramid":
                                r = q.funnelSection;
                                d > r.y1 && d < r.y4 && (r.y6 ? d > r.y6 ? (f = r.x6 + (r.x5 - r.x6) / (r.y5 - r.y6) * (d - r.y6), r = r.x3 + (r.x4 - r.x3) / (r.y4 - r.y3) * (d - r.y3)) : (f = r.x1 + (r.x6 - r.x1) / (r.y6 - r.y1) * (d - r.y1), r = r.x2 + (r.x3 - r.x2) / (r.y3 - r.y2) * (d - r.y2)) : (f = r.x1 +
                                    (r.x4 - r.x1) / (r.y4 - r.y1) * (d - r.y1), r = r.x2 + (r.x3 - r.x2) / (r.y3 - r.y2) * (d - r.y2)), a > f && a < r && (b.push({
                                    dataPoint: g,
                                    dataPointIndex: q.dataPointIndex,
                                    dataSeries: this,
                                    distance: 0
                            ...
                            case "boxAndWhisker":
                                if (a >= q.x1 - q.borderThickness / 2 && a <= q.x2 + q.borderThickness / 2 && d >= q.y4 - q.borderThickness / 2 && d <= q.y1 + q.borderThickness / 2 || Math.abs(q.x2 - a + q.x1 - a) < q.borderThickness && d >= q.y1 && d <= q.y4) b.push({
                                    ...
                                    dataPointIndex: f,
                                    dataSeries: this,
                                    distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y2 - d),
                                        Math.abs(q.y3 - d))
                                }), h = !0;
                                break;
                            case "candlestick":
                                ...
                                break;
                            case "ohlc":
                                if (Math.abs(q.x2 - a + q.x1 - a) < q.borderThickness && d >= q.y2 && d <= q.y3 || a >= q.x1 && a <= (q.x2 + q.x1) / 2 && d >= q.y1 - q.borderThickness /
                                    2 && d <= q.y1 + q.borderThickness / 2 || a >= (q.x1 + q.x2) / 2 && a <= q.x2 && d >= q.y4 - q.borderThickness / 2 && d <= q.y4 + q.borderThickness / 2) b.push({
                                    dataPoint: g,
                                    dataPointIndex: f,
                                    dataSeries: this,
                                    distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y2 - d), Math.abs(q.y3 - d))
        ...
        Q.prototype.getMarkerProperties = function(a, d, c, b) {
            var e =
                ...
                l = e[a].markerBorderColor ? e[a].markerBorderColor : this.markerBorderColor ? this.markerBorderColor : null,
        ...
        A.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.logarithmic && !this.equidistantInterval)
                    for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, g = q; b < this.logLabelValues.length; b++)
                        if (c = this.logLabelValues[b], c < this.viewportMinimum) b++;
                            ...
                            }) : "axisX" === this.type && this.labels[m] ? this.labels[m] : da(m, this.valueFormatString, this.chart._cultureInfo), a = new ja(this.ctx, {
                                x: 0,
                                y: 0,
                                maxWidth: f,
                                maxHeight: l,
                ...
                for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = Xa(new Date(this.viewportMaximum), this.interval, this.intervalType), g = q, c = this.intervalStartPosition; c <
                    e; Xa(c, b, this.intervalType)) {
                    ...
                    a || (a = this.labelFormatter ? this.labelFormatter({
                        ...
                        value: new Date(m),
                        label: this.labels[m] ? this.labels[m] : null
                    }) : "axisX" === this.type && this.labels[m] ? this.labels[m] : Ba(m, this.valueFormatString, this.chart._cultureInfo), a = new ja(this.ctx, {
                        x: 0,
                        y: 0,
                        maxWidth: f,
                        backgroundColor: this.labelBackgroundColor,
            ...
            if ("bottom" === this._position || "top" === this._position) h = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ?
                ...
                (l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize);
                ...
                Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * T[this.intervalType + "Duration"] * this.interval, this.chart.panEnabled || (f = "undefined" === typeof this.options.labelMaxWidth ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth), l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                    ...
                    if (f = 0.9 * h >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                for (var v, g = a.text.split(" "), b = 0; b < g.length; b++) m = g[b], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, m = this.ctx.measureText(m), m.width > q && (v = c, q = m.width)
                            } c = 0;
                            ...
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight =
                                        0 === this.labelAngle ? l : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), m = (k - (n + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !s(this.options.labelWrap)) this.labelWrap ? s(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), m), this.sessionVariables.labelWrap = this.labelWrap, d && r.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap =
                                        this.labelWrap, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle) : s(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelMaxWidth = f, d && r.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m)) : (this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth >
                                        f ? -25 : this.sessionVariables.labelAngle, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelWrap = this.labelWrap);
                                    else {
                                        if (s(this.options.labelWrap))
                                            ...
                                            if (b = r.width + d.width >> 0, g = this.labelFontSize, q < f) b - 2 * f > p && (p = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, s(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 2.2 * f && b < 2.8 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m, this.sessionVariables.labelFontSize = g) : b >= 2.8 *
                                                f && b < 3.2 * f ? (this.sessionVariables.labelMaxWidth = Math.max(f, q), this.sessionVariables.labelWrap = !0, s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * f && b < 3.6 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = m, this.sessionVariables.labelFontSize =
                                                    this.labelFontSize) : b > 3.6 * f && b < 5 * f ? (s(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m) : b > 5 * f && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelFontSize = g, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelAngle =
                                                    this.labelAngle));
                                            ...
                                            g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m;
                                        else if (0 === p)
                                            for (this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, b = 0; b < this._labels.length; b++) a = this._labels[b].textBlock, a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), m), r = a.measureText(), b < this._labels.length - 1 && (g = b + 1, d = this._labels[g].textBlock, d.maxWidth =
                                                this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), m), d = d.measureText(), r.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25))
                                    }
                                    ...
                                    f, this.sessionVariables.labelMaxHeight = this.labelWrap ? (k - m * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) : 1.5 * this.labelFontSize, s(this.options.labelWrap)) ? s(this.options.labelWrap) && (this.labelWrap && !s(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : m, this.sessionVariables.labelMaxHeight = l) : (this.sessionVariables.labelAngle = this.labelAngle,
                                    this.sessionVariables.labelMaxWidth = m, this.sessionVariables.labelMaxHeight = b < 0.9 * h ? 0.9 * h : b, this.sessionVariables.labelWrap = this.labelWrap)) : (this.options.labelWrap ? (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : m) : (s(this.options.labelMaxWidth), this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : m, this.sessionVariables.labelWrap = this.labelWrap), this.sessionVariables.labelMaxHeight =
                                    l)
                        ...
                        for (c = 0; c < this._labels.length; c++) a = this._labels[c].textBlock, a.maxWidth = this.labelMaxWidth = s(this.options.labelMaxWidth) ? s(this.sessionVariables.labelMaxWidth) ?
                            ...
                            a.wrap = this.labelWrap = s(this.options.labelWrap) ? s(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = s(this.sessionVariables.labelMaxHeight) ? this.sessionVariables.labelMaxHeight = l : this.sessionVariables.labelMaxHeight, a.measureText();
            else if ("left" === this._position || "right" === this._position)
                if (f = s(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, l = "undefined" === typeof this.options.labelWrap ||
                    ...
                    for (c = 0; c < this._labels.length; c++) a =
                        ...
                        this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = s(this.options.labelWrap) ? s(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = s(this.sessionVariables.labelMaxHeight) ? this.sessionVariables.labelMaxHeight = l : this.sessionVariables.labelMaxHeight, a.measureText();
            for (c = 0; c < this.stripLines.length; c++) {
                ...
                if ("outside" ===
                    ...
                    if ("bottom" === this._position || "top" === this._position) s(f.options.labelWrap) && !s(this.sessionVariables.stripLineLabelMaxHeight) ? A = this.sessionVariables.stripLineLabelMaxHeight : this.sessionVariables.stripLineLabelMaxHeight = A = f.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                    if ("left" === this._position || "right" === this._position) s(f.options.labelWrap) && !s(this.sessionVariables.stripLineLabelMaxHeight) ? A = this.sessionVariables.stripLineLabelMaxHeight :
                        this.sessionVariables.stripLineLabelMaxHeight = A = f.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
                    s(f.labelBackgroundColor) && (f.labelBackgroundColor = "#EEEEEE")
                } else l = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0, A = s(f.options.labelWrap) || f.labelWrap ? "bottom" === this._position || "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize, s(f.labelBackgroundColor) && (s(f.startValue) && 0 !== f.startValue ? f.labelBackgroundColor =
        ...
        A.prototype.createLabelsAndCalculateWidth = function() {
            ...
            if ("left" === this._position || "right" === this._position) {
                ...
                for (d = 0; d < this._stripLineLabels.length; d++) "outside" === this._stripLineLabels[d].stripLine.labelPlacement && (this._stripLineLabels[d].stripLine.value >= this.viewportMinimum && this._stripLineLabels[d].stripLine.value <= this.viewportMaximum) && (b = this._stripLineLabels[d].textBlock, e = b.measureText(), f = 0 === this.labelAngle ? e.width : e.width * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) +
                    (e.height - b.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), "inside" === this.tickPlacement && (f += this.tickLength), "inside" === this.labelPlacement && (a += 0 < this._index ? f : 0), a < f && (a = f), this.stripLineLabelEffectiveWidth = this._stripLineLabels[d].effectiveWidth = f)
            }
            ...
            if ("bottom" === this._position || "top" === this._position) {
                ...
                if ("inside" != this.labelPlacement || "inside" === this.labelPlacement && 0 < this._index)
                    for (c = 0; c < this._labels.length; c++) {
                        ...
                        this._labels[c].effectiveHeight =
                            f
                    }
                for (c = 0; c < this._stripLineLabels.length; c++) "outside" === this._stripLineLabels[c].stripLine.labelPlacement && (this._stripLineLabels[c].stripLine.value >= this.viewportMinimum && this._stripLineLabels[c].stripLine.value <= this.viewportMaximum) && (d = this._stripLineLabels[c].textBlock, e = d.measureText(), f = 0 === this.labelAngle ? e.height : e.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (e.height - d.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), "inside" === this.tickPlacement && (f += this.tickLength),
                    "inside" === this.labelPlacement && (a += 0 < this._index ? f : 0), a < f && (a = f), this.stripLineLabelEffectiveHeight = this._stripLineLabels[c].effectiveHeight = f)
            }
        ...
        A.setLayout = function(a, d, c, b, e, f) {
            var l, h, n, k, m = a[0] ? a[0].chart : d[0].chart,
            ...
            if (d && 0 < d.length)
                for (g =
                    0; g < d.length; g++) d[g].calculateAxisParameters();
            if (c && 0 < c.length)
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
                    for (var r = q[g].scaleBreaks._appliedBreaks, w = 0; w < r.length && !(r[w].startValue > q[g].viewportMaximum); w++) r[w].endValue < q[g].viewportMinimum || (s(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w), r[w].startValue >=
                        q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
            for (var v = w = 0, u = 0, y = 0, x = 0, z = 0, A = 0, D, B, E = h = 0, G, J, K, r = G = J = K = !1, g = 0; g < q.length; g++) q[g] && q[g].title && (q[g]._titleTextBlock = new ja(q[g].ctx, {
                text: q[g].title,
                horizontalAlign: "center",
            ...
            for (g = 0; g < q.length; g++)
                if (q[g].title) switch (q[g]._position) {
                    ...
                    case "right":
                        ...
                        break;
                    default:
                        q[g]._titleTextBlock.maxWidth =
                            q[g].titleMaxWidth || f.width, q[g]._titleTextBlock.maxHeight = q[g].titleWrap ? 0.8 * f.height : 1.5 * q[g].titleFontSize, q[g]._titleTextBlock.angle = 0
                }
            if ("normal" === e) {
                for (var y = [], x = [], z = [], A = [], M = [], Q = [], N = [], P = []; 4 > w;) {
                    var F = 0,
                        X = 0,
                        T = 0,
                        U = 0,
                        ...
                        aa = 0;
                    if (c && 0 < c.length)
                        for (z = [], g = R = 0; g < c.length; g++) z.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), R += z[g], O += c[g] && !m.isNavigator ? c[g].margin : 0;
                    ...
                    n = Math.round(f.x2 - aa - Z > m.width - p ? m.width - p : f.x2 - aa - Z);
                    if (a && 0 < a.length)
                        for (y = [], g = W = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates = {}), a[g].lineCoordinates.width = Math.abs(n - l), a[g].title && (a[g]._titleTextBlock.maxWidth = 0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.width ?
                            a[g].titleMaxWidth : a[g].lineCoordinates.width), y.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateHeight() : 0)), W += y[g], e += a[g] && !m.isNavigator ? a[g].margin : 0;
                    else y.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
                    M.push(y);
                    if (d && 0 < d.length)
                        for (x = [], g = Y = 0; g < d.length; g++) d[g] && (d[g].lineCoordinates = {}), d[g].lineCoordinates.width = Math.abs(n - l), d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.width ? d[g].titleMaxWidth : d[g].lineCoordinates.width),
                            x.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)), Y += x[g], V += d[g] && !m.isNavigator ? d[g].margin : 0;
                    else x.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                    Q.push(x);
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates.x1 = l, n = Math.round(f.x2 - aa - Z > m.width - p ? m.width - p : f.x2 - aa - Z), a[g]._labels && 1 < a[g]._labels.length && (h = k = 0, k = a[g]._labels[1], h = "dateTime" === a[g].valueType ? a[g]._labels[a[g]._labels.length - 2] : a[g]._labels[a[g]._labels.length - 1], v = k.textBlock.width * Math.cos(Math.PI /
                                180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), u = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle))), !a[g] || (!a[g].labelAutoFit || s(D) || s(B) || m.isNavigator || m.stockChart) || (h = 0, 0 < a[g].labelAngle ? B + u > n && (h += 0 < a[g].labelAngle ? B + u - n - aa : 0) : 0 > a[g].labelAngle ? D - v < l && D - v < a[g].viewportMinimum && (E = l - (O + a[g].tickLength +
                                z + D - v + a[g].labelFontSize / 2)) : 0 === a[g].labelAngle && (B + u > n && (h = B + u / 2 - n - aa), D - v < l && D - v < a[g].viewportMinimum && (E = l - O - a[g].tickLength - z - D + v / 2)), a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < h ? n -= h : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < E ? l += E : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < E && (l += E), 0 < h && (n -= h))), m.panEnabled ? W = s(m.sessionVariables.axisX.height) ?
                            m.sessionVariables.axisX.height = W : m.sessionVariables.axisX.height : m.sessionVariables.axisX.height = W, h = Math.round(f.y2 - W - e + F), k = Math.round(f.y2), a[g].lineCoordinates.x2 = n, a[g].lineCoordinates.width = n - l, a[g].lineCoordinates.y1 = h, a[g].lineCoordinates.y2 = h + a[g].lineThickness / 2, "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.y1 = a[g - 1].lineCoordinates.y2 + F + (a[g].labelEffectiveHeight || 0), a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2), "inside" === a[g].tickPlacement && 0 < g &&
                            (a[g].lineCoordinates.y1 += a[g].tickLength, a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2), a[g].bounds = {
                                x1: l,
                                y1: h,
                                x2: n,
                                y2: k - (W + e - y[g] - F),
                                width: n - l
                            }, a[g].bounds.height = a[g].bounds.y2 - a[g].bounds.y1), F += y[g] + a[g].margin;
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) d[g].lineCoordinates.x1 = Math.round(f.x1 + R + O), d[g].lineCoordinates.x2 = Math.round(f.x2 - aa - Z > m.width - p ? m.width - p : f.x2 - aa - Z), d[g].lineCoordinates.width = Math.abs(n - l), d[g]._labels && 1 < d[g]._labels.length && (k = d[g]._labels[1], h = "dateTime" ===
                                d[g].valueType ? d[g]._labels[d[g]._labels.length - 2] : d[g]._labels[d[g]._labels.length - 1], v = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), u = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle))), m.panEnabled ? Y = s(m.sessionVariables.axisX2.height) ? m.sessionVariables.axisX2.height = Y :
                            m.sessionVariables.axisX2.height : m.sessionVariables.axisX2.height = Y, h = Math.round(f.y1), k = d[g].lineCoordinates.y1 = h + Y + V - X, d[g].lineCoordinates.y2 = h, "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.y1 = d[g - 1].lineCoordinates.y1 - X - (d[g].labelEffectiveHeight || 0)), "inside" === d[g].tickPlacement && 0 < g && (d[g].lineCoordinates.y1 -= d[g].tickLength), d[g].bounds = {
                                x1: l,
                                y1: h + (Y + V - x[g] - X),
                                x2: n,
                                y2: k,
                                width: n - l
                            }, d[g].bounds.height = d[g].bounds.y2 - d[g].bounds.y1, X += x[g] + d[g].margin;
                    if (c && 0 < c.length)
                        for (g = 0; g <
                            c.length; g++) O = m.isNavigator ? 0 : 10, c[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), O = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : p, h = Math.round(f.y1 + Y + V < Math.max(O, p) ? Math.max(O, p) : f.y1 + Y + V), n = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), O = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : p, k = Math.round(f.y2 - W - e - O), c[g].lineCoordinates = {
                            x1: l - T,
                            y1: h,
                            x2: n - T,
                            y2: k,
                            ...
                            y2: k,
                            height: k - h
                        }, c[g].bounds.width = c[g].bounds.x2 - c[g].bounds.x1, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth &&
                            c[g].titleMaxWidth < c[g].lineCoordinates.height ? c[g].titleMaxWidth : c[g].lineCoordinates.height), T += z[g] + c[g].margin);
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), n = Math.round(l), O = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(f.y1 + Y + V < Math.max(O, p) ? Math.max(O, p) : f.y1 + Y + V), O = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 -
                                (W + e + O)), b[g].lineCoordinates = {
                                x1: l + U,
                                y1: h,
                                x2: l + U,
                                y2: k,
                                height: Math.abs(k - h)
                            }, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.x1 = b[g - 1].lineCoordinates.x2 + U + (b[g].labelEffectiveWidth || 0), b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2), "inside" === b[g].tickPlacement && 0 < g && (b[g].lineCoordinates.x1 += b[g].tickLength, b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2), b[g].bounds = {
                                x1: l + U,
                                y1: h,
                                x2: n + (A[g] + U),
                                y2: k,
                                height: k - h
                            }, b[g].bounds.width = b[g].bounds.x2 -
                            b[g].bounds.x1, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.height ? b[g].titleMaxWidth : b[g].lineCoordinates.height), U += A[g] + b[g].margin);
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) a[g] && (a[g].calculateValueToPixelConversionParameters(), a[g].calculateBreaksSizeInValues(), a[g]._labels && 1 < a[g]._labels.length && (D = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase : a[g]._labels[1].position -
                            a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1, l = a[g]._labels[a[g]._labels.length - ("dateTime" === a[g].valueType ? 2 : 1)].position, l = a[g].getApparentDifference(a[g].viewportMinimum, l), B = a[g].logarithmic ? (1 < l ? Math.log(l) / a[g].conversionParameters.lnLogarithmBase * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1));
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) d[g].calculateValueToPixelConversionParameters(),
                            d[g].calculateBreaksSizeInValues(), d[g]._labels && 1 < d[g]._labels.length && (D = (d[g].logarithmic ? Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1, l = d[g]._labels[d[g]._labels.length - ("dateTime" === d[g].valueType ? 2 : 1)].position, l = d[g].getApparentDifference(d[g].viewportMinimum, l), B = d[g].logarithmic ? (1 < l ? Math.log(l) / d[g].conversionParameters.lnLogarithmBase *
                                Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1);
                    for (g = 0; g < q.length; g++) "axisY" === q[g].type && (q[g].calculateValueToPixelConversionParameters(), q[g].calculateBreaksSizeInValues());
                    if (0 < w) {
                        if (a && 0 < a.length)
                            for (g = 0; g < a.length; g++) r = M[w - 1][g] === M[w][g] ? !0 : !1;
                        else r = !0;
                        if (d && 0 < d.length)
                            for (g = 0; g < d.length; g++) G = Q[w - 1][g] === Q[w][g] ? !0 : !1;
                        else G = !0;
                        if (c && 0 < c.length)
                            for (g = 0; g < c.length; g++) J = N[w - 1][g] ===
                                N[w][g] ? !0 : !1;
                        else J = !0;
                        if (b && 0 < b.length)
                            for (g = 0; g < b.length; g++) K = P[w - 1][g] === P[w][g] ? !0 : !1;
                        else K = !0
                    }
                    if (r && G && J && K) break;
                    w++
                ...
                if (b && 0 < b.length)
                    for (g = 0; g < b.length; g++) b[g].calculateStripLinesThicknessInValues(),
                ...
                for (Q = []; 4 > w;) {
                    ...
                    if (a && 0 < a.length)
                        for (E = [], g = U = 0; g < a.length; g++) E.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), U += E[g], e += a[g] && !m.isNavigator ? a[g].margin : 0;
                    else E.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    M.push(E);
                    if (d && 0 < d.length)
                        for (v = [], g = W = 0; g < d.length; g++) v.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), W += v[g], V += d[g] ? d[g].margin : 0;
                    else v.push(Math.ceil(d[0] ?
                        d[0].createLabelsAndCalculateWidth() : 0));
                    Q.push(v);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) c[g].lineCoordinates = {}, l = Math.round(f.x1 + U + e), n = Math.round(f.x2 - W - V > m.width - 10 ? m.width - 10 : f.x2 - W - V), c[g].labelAutoFit && !s(y) && (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, y) : 0 === c[g].labelAngle ? Math.max(l, y / 2) : l), 0 < !d.length && (n = 0 < c[g].labelAngle ? n - x / 2 : 0 === c[g].labelAngle ? n - x / 2 : n)), c[g].lineCoordinates.x1 = l, c[g].lineCoordinates.x2 = n, c[g].lineCoordinates.width = Math.abs(n - l), c[g].title && (c[g]._titleTextBlock.maxWidth =
                            0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width);
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g].lineCoordinates = {}, l = Math.round(f.x1 + U + e), n = Math.round(f.x2 - W - V > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - W - V), b[g] && b[g].labelAutoFit && !s(z) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, z) : 0 === b[g].labelAngle ? Math.max(l, z / 2) : l), 0 < !d.length && (n -= A / 2)), b[g].lineCoordinates.x1 = l, b[g].lineCoordinates.x2 = n, b[g].lineCoordinates.width = Math.abs(n -
                            l), b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width);
                    if (c && 0 < c.length)
                        for (p = [], g = T = 0; g < c.length; g++) p.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), T += p[g] + c[g].margin, O += c[g].margin;
                    ...
                    if (m.panEnabled)
                        for (g = 0; g < c.length; g++) p[g] = s(m.sessionVariables.axisY[g].height) ?
                            m.sessionVariables.axisY[g].height = p[g] : m.sessionVariables.axisY[g].height;
                    else
                        for (g = 0; g < c.length; g++) m.sessionVariables.axisY[g].height = p[g];
                    if (c && 0 < c.length)
                        for (g = c.length - 1; 0 <= g; g--) h = Math.round(f.y2), k = Math.round(f.y2 > c[g].chart.height ? c[g].chart.height : f.y2), c[g].lineCoordinates.y1 = h - (p[g] + c[g].margin + Y), c[g].lineCoordinates.y2 = h - (p[g] + c[g].margin + Y), "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + p[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) -
                                c[g].tickLength - (c[g].stripLineLabelEffectiveHeight || 0) - 5, c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2), "inside" === c[g].tickPlacement && 0 < g && (c[g].lineCoordinates.y1 += c[g].tickLength, c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2), c[g].bounds = {
                                x1: l,
                            ...
                            Y += p[g] + c[g].margin;
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--) b[g] && (h = Math.round(f.y1), k = Math.round(f.y1 + (D[g] + b[g].margin + F)), b[g].lineCoordinates.y1 = k, b[g].lineCoordinates.y2 = k, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = k - D[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0) + b[g].tickLength + (b[g].stripLineLabelEffectiveHeight || 0), b[g].lineCoordinates.y2 = b[g].lineCoordinates.y1 - b[g].lineThickness / 2), "inside" === b[g].tickPlacement && 0 < g && (b[g].lineCoordinates.y1 -= b[g].tickLength,
                            ...
                            y2: k,
                            width: n - l
                        }, b[g].bounds.height = b[g].bounds.y2 - b[g].bounds.y1, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width), F += D[g] + b[g].margin);
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) {
                            O = a[g]._labels && 0 < a[g]._labels.length ? a[g]._labels[0].textBlock.fontSize / 2 : 0;
                            l = Math.round(f.x1 + e);
                            h = b &&
                                0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 < Math.max(O, 10) ? Math.max(O, 10) : f.y1) : f.y1 < Math.max(O, 10) ? Math.max(O, 10) : f.y1;
                            n = Math.round(f.x1 + U + e);
                            k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - T > m.height - Math.max(O, 10) ? m.height - Math.max(O, 10) : f.y2 - T) : f.y2 > m.height - Math.max(O, 10) ? m.height - Math.max(O, 10) : f.y2;
                            if (c && 0 < c.length)
                                for (O = 0; O < c.length; O++) c[O] && c[O].labelAutoFit && (n = c[O].lineCoordinates.x1, l = 0 > c[O].labelAngle || 0 === c[O].labelAngle ? n - U : l);
                            if (b && 0 < b.length)
                                for (O = 0; O < b.length; O++) b[O] &&
                                    b[O].labelAutoFit && (n = b[O].lineCoordinates.x1, l = n - U);
                            a[g].lineCoordinates = {
                                x1: n - N,
                                y1: h,
                                x2: n - N,
                            ...
                            "inside" === a[g].tickPlacement && 0 < g && (a[g].lineCoordinates.x1 -= a[g].tickLength, a[g].lineCoordinates.x2 = a[g].lineCoordinates.x1 +
                                a[g].lineThickness / 2);
                            a[g].bounds = {
                                x1: n - (E[g] + N),
                                y1: h,
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            O = d[g]._labels && 0 < d[g]._labels.length ? d[g]._labels[0].textBlock.fontSize /
                                2 : 0;
                            l = Math.round(f.x1 - e);
                            h = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 < Math.max(O, 10) ? Math.max(O, 10) : f.y1) : f.y1 < Math.max(O, 10) ? Math.max(O, 10) : f.y1;
                            n = Math.round(f.x2 - W - V);
                            k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - T > m.height - Math.max(O, 10) ? m.height - Math.max(O, 10) : f.y2 - T) : f.y2 > m.height - Math.max(O, 10) ? m.height - Math.max(O, 10) : f.y2;
                            if (c && 0 < c.length)
                                for (O = 0; O < c.length; O++) c[O] && c[O].labelAutoFit && (n = 0 > c[O].labelAngle ? Math.max(n, y) : 0 === c[O].labelAngle ? Math.max(n, y / 2) : n, l =
                                    0 > c[O].labelAngle || 0 === c[O].labelAngle ? n - W : l);
                            if (b && 0 < b.length)
                                for (O = 0; O < b.length; O++) b[O] && b[O].labelAutoFit && (n = b[O].lineCoordinates.x2, l = n - W);
                            d[g].lineCoordinates = {
                                x1: n + P,
                                y1: h,
                                x2: n + P,
                            ...
                            "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.x1 = d[g].lineCoordinates.x1 + (v[g] - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0) - 2) - d[g].tickLength - (d[g].stripLineLabelEffectiveWidth || 0), d[g].lineCoordinates.x2 = d[g].lineCoordinates.x1 + d[g].lineThickness / 2);
                            "inside" === d[g].tickPlacement &&
                                0 < g && (d[g].lineCoordinates.x1 += d[g].tickLength, d[g].lineCoordinates.x2 = d[g].lineCoordinates.x1 + d[g].lineThickness / 2);
                            d[g].bounds = {
                ...
                if (c && 0 < c.length)
                    for (g =
                        0; g < c.length; g++) c[g].calculateStripLinesThicknessInValues(), c[g].calculateBreaksInPixels();
                if (b && 0 < b.length)
        ...
        A.render = function(a, d, c, b, e) {
            ...
            if (b && 0 < b.length)
                for (l =
                    0; l < b.length; l++) b[l].renderLabelsTicksAndTitle();
            f.preparePlotArea();
            f = f.plotArea;
            e.save();
            e.beginPath();
            ...
            e.restore();
            if (a && 0 < a.length)
                for (l = 0; l < a.length; l++) a[l].renderGrid(), w && (a[l].createMask(), a[l].renderBreaksBackground());
            if (d && 0 < d.length)
        ...
        A.prototype.calculateStripLinesThicknessInValues = function() {
            for (var a = 0; a < this.stripLines.length; a++)
                if (null !== this.stripLines[a].startValue && null !== this.stripLines[a].endValue) {
                    ...
                    this.stripLines[a]._thicknessType =
                        "value"
                }
        };
        A.prototype.calculateBreaksSizeInValues = function() {
            for (var a = "left" === this._position || "right" === this._position ? this.lineCoordinates.height || this.chart.height : this.lineCoordinates.width || this.chart.width, d = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], c = this.conversionParameters.pixelPerUnit || a / (this.logarithmic ? this.conversionParameters.maximum / this.conversionParameters.minimum : this.conversionParameters.maximum - this.conversionParameters.minimum), b = this.scaleBreaks && !s(this.scaleBreaks.options.spacing),
                    e, f = 0; f < d.length; f++) e = b || !s(d[f].options.spacing), d[f].spacing = Ta(d[f].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0, d[f].size = 0 > d[f].spacing ? 0 : Math.abs(d[f].spacing / c), this.logarithmic && (d[f].size = Math.pow(this.logarithmBase, d[f].size))
        };
        A.prototype.calculateBreaksInPixels = function() {
            if (!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {
                ...
                for (var d = 0; d < a.length &&
                    !(a[d].startValue > this.conversionParameters.maximum); d++) a[d].endValue < this.conversionParameters.minimum || (s(this.scaleBreaks.firstBreakIndex) && (this.scaleBreaks.firstBreakIndex = d), a[d].startValue >= this.conversionParameters.minimum && (a[d].startPixel = this.convertValueToPixel(a[d].startValue), this.scaleBreaks.lastBreakIndex = d), a[d].endValue <= this.conversionParameters.maximum && (a[d].endPixel = this.convertValueToPixel(a[d].endValue)))
            }
        };
        A.prototype.renderLabelsTicksAndTitle = function() {
            ...
            if ("undefined" === typeof this.options.interval) {
                if ("bottom" === this._position || "top" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, l, h = this.viewportMaximum, n = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                            p = this._labels[k];
                            if (p.position < this.viewportMinimum) break;
                            p.position > this.viewportMaximum || !(k ===
                                this._labels.length - 1 || l < Math.log(h / p.position) * n / e) || (c.push(p), h = p.position, l = p.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                        }
                        this._labels = c
                    } else {
                        for (k = 0; k < this._labels.length; k++) p = this._labels[k], p.position < this.viewportMinimum || (l = p.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += l);
                        c > this.lineCoordinates.width * e && this.labelAutoFit &&
                            (d = !0)
                    } if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], m, h = this.viewportMaximum, n = this.lineCoordinates.height / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                            p = this._labels[k];
                            if (p.position < this.viewportMinimum) break;
                            p.position > this.viewportMaximum || !(k === this._labels.length - 1 || m < Math.log(h / p.position) * n) || (c.push(p), h = p.position, m = p.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.width *
            ...
            if ("bottom" ===
                ...
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationIterationEnd", function() {
                    for (k = 0; k < a._labels.length; k++)
                        if (p = a._labels[k], !(p.position <
                                a.viewportMinimum || p.position > a.viewportMaximum) && (q = a.getPixelCoordinatesOnAxis(p.position), a.tickThickness)) {
                ...
                this.title && (this._titleTextBlock.measureText(), this._titleTextBlock.x = this.lineCoordinates.x1 + this.lineCoordinates.width / 2 - this._titleTextBlock.width /
                    2, this._titleTextBlock.y = this.bounds.y2 - this._titleTextBlock.height - 3, this.titleMaxWidth = this._titleTextBlock.maxWidth, this._titleTextBlock.render(!0))
            } else if ("top" === this._position) {
                for (k = 0; k < this._labels.length; k++) p = this._labels[k], p.position < this.viewportMinimum || p.position > this.viewportMaximum || (q = this.getPixelCoordinatesOnAxis(p.position), this.tickThickness && "inside" != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? (q.x <<
                    0) + 0.5 : q.x << 0, this.ctx.beginPath(), this.ctx.moveTo(b, q.y << 0), this.ctx.lineTo(b, q.y - this.tickLength << 0), this.ctx.stroke()), d && 0 !== f++ % 2 && this.labelAutoFit || (0 === p.textBlock.angle ? (q.x -= p.textBlock.width / 2, q.y = "inside" === this.labelPlacement ? q.y + this.labelFontSize / 2 + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : q.y - (("inside" === this.tickPlacement ? 0 : this.tickLength) + p.textBlock.height - p.textBlock.fontSize / 2)) : (q.x = "inside" === this.labelPlacement ? 0 < this.labelAngle ? q.x : q.x - p.textBlock.width * Math.cos(Math.PI /
                    180 * this.labelAngle) : q.x + (p.textBlock.height - this.labelFontSize) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? p.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0), q.y = "inside" === this.labelPlacement ? 0 < this.labelAngle ? q.y + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : q.y - p.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : q.y - (("inside" === this.tickPlacement ? 0 : this.tickLength) + ((p.textBlock.height - p.textBlock.fontSize / 2) *
                    Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? p.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0)))), p.textBlock.x = q.x, p.textBlock.y = q.y));
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationIterationEnd", function() {
                    for (k = 0; k < a._labels.length; k++)
                ...
                for (k = 0; k < this._labels.length; k++) p = this._labels[k],
                    p.position < this.viewportMinimum || p.position > this.viewportMaximum || (q = this.getPixelCoordinatesOnAxis(p.position), this.tickThickness && "inside" != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? (q.y << 0) + 0.5 : q.y << 0, this.ctx.beginPath(), this.ctx.moveTo(q.x << 0, b), this.ctx.lineTo(q.x - this.tickLength << 0, b), this.ctx.stroke()), d && 0 !== f++ % 2 && this.labelAutoFit || (0 === this.labelAngle ? (p.textBlock.y = q.y, p.textBlock.x = "inside" === this.labelPlacement ?
                        q.x + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : q.x - p.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength) - 5) : (p.textBlock.y = "inside" === this.labelPlacement ? q.y : q.y - p.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle), p.textBlock.x = "inside" === this.labelPlacement ? q.x + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : 0 < this.labelAngle ? q.x - p.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength) -
                        5 : q.x - p.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) + (p.textBlock.height - p.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength))));
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationIterationEnd", function() {
                    for (k = 0; k < a._labels.length; k++)
                        if (p = a._labels[k], !(p.position < a.viewportMinimum || p.position > a.viewportMaximum) && (q = a.getPixelCoordinatesOnAxis(p.position), a.tickThickness)) {
                            a.ctx.lineWidth = a.tickThickness;
        ...
        A.prototype.renderStripLinesOfThicknessType =
            function(a) {
                if (this.stripLines && 0 < this.stripLines.length && a) {
                    for (var d = this, c, b = 0, e = 0, f = !1, l = !1, h = [], n = [], l = !1, b = 0; b < this.stripLines.length; b++) {
                        var k = this.stripLines[b];
                        k._thicknessType === a && ("pixel" === a && (k.value < this.viewportMinimum || k.value > this.viewportMaximum || s(k.value) || isNaN(this.range)) || "value" === a && (k.startValue <= this.viewportMinimum && k.endValue <= this.viewportMinimum || k.startValue >= this.viewportMaximum && k.endValue >= this.viewportMaximum || s(k.startValue) || s(k.endValue) || isNaN(this.range)) ||
                            h.push(k))
                    }
                    for (b = 0; b < this._stripLineLabels.length; b++)
                        if (k = this.stripLines[b], c = this._stripLineLabels[b], !(c.position < this.viewportMinimum || c.position > this.viewportMaximum || isNaN(this.range))) {
                            ...
                            if ("outside" === c.stripLine.labelPlacement)
                                ...
                                } else "top" === this._position ? (m = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, this.ctx.beginPath(), this.ctx.moveTo(m, a.y << 0), this.ctx.lineTo(m, a.y - this.tickLength <<
                        ...
                        this.ctx.save();
                        this.ctx.beginPath();
                        this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width,
                        ...
                        for (b = 0; b < n.length; b++) c = n[b], c.stripLine.showOnTop ? l || (l = !0, this.chart.addEventListener("dataAnimationIterationEnd",
                            function() {
                                for (e = 0; e < n.length; e++) c = n[e], "inside" === c.stripLine.labelPlacement && c.stripLine.showOnTop && (d.ctx.save(), d.ctx.beginPath(), d.ctx.rect(d.chart.plotArea.x1, d.chart.plotArea.y1, d.chart.plotArea.width, d.chart.plotArea.height), d.ctx.clip(), c.textBlock.render(!0), d.ctx.restore())
                            }, c.textBlock)) : "inside" === c.stripLine.labelPlacement && c.textBlock.render(!0);
                        this.ctx.restore();
                        l = !0
                    }
                    if (l)
                        for (l = !1, b = 0; b < n.length; b++) c = n[b], "outside" === c.stripLine.labelPlacement && c.textBlock.render(!0)
                }
            };
        A.prototype.renderBreaksBackground =
            function() {
        ...
        A.prototype.createMask =
            function() {
                if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
                    ...
                    this.maskCtx.clip();
                    for (var d = 0; d < a.length; d++) a[d].endValue <
                        this.viewportMinimum || (a[d].startValue > this.viewportMaximum || isNaN(this.range)) || a[d].render(this.maskCtx);
        ...
        A.prototype.showCrosshair = function(a) {
            s(a) || (a < this.viewportMinimum || a > this.viewportMaximum) || ("top" === this._position || "bottom" === this._position ? this.crosshair.render(this.convertValueToPixel(a), null, a) : this.crosshair.render(null, this.convertValueToPixel(a),
                a))
        };
        A.prototype.renderGrid = function() {
            if (this.gridThickness && 0 < this.gridThickness) {
                ...
                if ("bottom" === this._position || "top" === this._position)
                    for (b = 0; b < this._labels.length; b++) this._labels[b].position < this.viewportMinimum || (this._labels[b].position > this.viewportMaximum || this._labels[b].breaksLabelType) || (a.beginPath(),
                        d = this.getPixelCoordinatesOnAxis(this._labels[b].position), d = 1 === a.lineWidth % 2 ? (d.x << 0) + 0.5 : d.x << 0, a.moveTo(d, c.y1 << 0), a.lineTo(d, c.y2 << 0), a.stroke());
                else if ("left" === this._position || "right" === this._position)
                    for (var b = 0; b < this._labels.length; b++) this._labels[b].position < this.viewportMinimum || (this._labels[b].position > this.viewportMaximum || this._labels[b].breaksLabelType) || (a.beginPath(), d = this.getPixelCoordinatesOnAxis(this._labels[b].position), d = 1 === a.lineWidth % 2 ? (d.y << 0) + 0.5 : d.y << 0, a.moveTo(c.x1 <<
                        0, d), a.lineTo(c.x2 << 0, d), a.stroke());
                a.restore()
            }
        };
        A.prototype.renderAxisLine = function() {
            ...
            if ("bottom" === this._position || "top" === this._position) {
                if (this.lineThickness) {
                    ...
                    if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                        if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
                            ...
                            for (var h = this.scaleBreaks.firstBreakIndex; h <= this.scaleBreaks.lastBreakIndex; h++) d.moveTo(e, l), d.lineTo(this.scaleBreaks._appliedBreaks[h].startPixel +
                                c, l), e = this.scaleBreaks._appliedBreaks[h].endPixel + b;
                ...
                d.setLineDash && d.setLineDash(J(this.lineDashType, this.lineThickness));
                l = 1 === this.lineThickness % 2 ? (this.lineCoordinates.x1 << 0) + 0.5 : this.lineCoordinates.x1 <<
                    0;
                d.beginPath();
                if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
            ...
            w && (a.drawImage(this.chart._preRenderCanvas, 0, 0, this.chart.width,
                this.chart.height), this.chart._breaksCanvasCtx && this.chart._breaksCanvasCtx.drawImage(this.chart._preRenderCanvas, 0, 0, this.chart.width, this.chart.height), d.clearRect(0, 0, this.chart.width, this.chart.height));
            d.restore()
        };
        ...
        A.prototype.convertPixelToValue = function(a) {
            ...
            if (this.logarithmic) {
                ...
                if (c <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !== this.reversed)
                            ...
                            if (d)
                                if (e[c].startValue < this.conversionParameters.minimum) {
                                    if (1 < e[c].size && this.conversionParameters.minimum * Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size)) < e[c].endValue) {
                                        ...
                                        break
                                    } else a *= e[c].endValue / this.conversionParameters.minimum / Math.pow(e[c].size, Math.log(e[c].endValue / this.conversionParameters.minimum) / Math.log(e[c].endValue / e[c].startValue)),
                    ...
                    if (b > 1 / e[c].size) {
                        a *= Math.pow(e[c].endValue /
                            e[c].startValue, 1 >= e[c].size ? 1 : Math.log(b) / Math.log(e[c].size)) * b;
                        break
                    } else a /= e[c].endValue / e[c].startValue / e[c].size;
                    b *= e[c].size;
                    d = !1
                            ...
                            if (d)
                                if (e[c].startValue < this.conversionParameters.minimum) {
                                    if (e[c].size && this.conversionParameters.minimum + b * (e[c].endValue - e[c].startValue) / e[c].size < e[c].endValue) {
                                        ...
                                        break
                                    } else a += e[c].endValue - this.conversionParameters.minimum - e[c].size * (e[c].endValue -
                                        this.conversionParameters.minimum) / (e[c].endValue - e[c].startValue), b -= e[c].size * (e[c].endValue - this.conversionParameters.minimum) / (e[c].endValue - e[c].startValue);
                                    d = !1
                                } else if (b > e[c].startValue - this.conversionParameters.minimum) {
                            b -= e[c].startValue - this.conversionParameters.minimum;
                            if (b < e[c].size) {
                                ...
                                if (d)
                                    if (e[c].endValue > this.conversionParameters.minimum)
                                        if (e[c].size && this.conversionParameters.minimum + b * (e[c].endValue - e[c].startValue) / e[c].size > e[c].startValue) {
                                            ...
                                            e[c].startValue - this.conversionParameters.minimum + e[c].size * (this.conversionParameters.minimum - e[c].startValue) / (e[c].endValue - e[c].startValue), b += e[c].size * (this.conversionParameters.minimum - e[c].startValue) / (e[c].endValue - e[c].startValue), d = !1;
                else if (b < e[c].endValue - this.conversionParameters.minimum) {
                    b -= e[c].endValue - this.conversionParameters.minimum;
                    if (b > -1 * e[c].size) {
                        a += (e[c].endValue - e[c].startValue) * (0 === e[c].size ? 1 : b / e[c].size) + b;
        ...
        A.prototype.convertValueToPixel = function(a) {
            ...
            return this.logarithmic ? this.conversionParameters.reference + this.conversionParameters.pixelPerUnit *
                Math.log(a / this.conversionParameters.minimum) / this.conversionParameters.lnLogarithmBase + 0.5 << 0 : "axisX" === this.type ? this.conversionParameters.reference + this.conversionParameters.pixelPerUnit * (a - this.conversionParameters.minimum) + 0.5 << 0 : this.conversionParameters.reference + this.conversionParameters.pixelPerUnit * (a - this.conversionParameters.minimum) + 0.5
        };
        A.prototype.getApparentDifference = function(a, d, c, b) {
            ...
            if (this.logarithmic) {
                ...
                for (var f =
                    ...
                    a) / Math.log(e[f].endValue / e[f].startValue))))
            } else
                ...
                if (this.scaleBreaks)
                    for (l = 0; l < this.scaleBreaks._appliedBreaks.length; l++)
                        if ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[l].startValue || !s(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[l].startValue || !s(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[l].startValue) && (!s(this.sessionVariables.newViewportMaximum) &&
                                this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[l].endValue || !s(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[l].endValue || !s(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[l].endValue)) {
            ...
            if (0 !==
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (b = 1 === p % 2 ? (b.x << 0) + 0.5 : b.x << 0, l = 1 === p % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, h = this.chart.plotArea.y2 +
                            p / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, h = this.chart.plotArea.y1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = {
                            x1: b - p / 2,
                            y1: e,
                            x2: l + p / 2,
                            y2: h
                        }, this.ctx.moveTo(b, e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, h), this.ctx.lineTo(l, h), this.ctx.lineTo(l, e);
                    else if ("wavy" === this.type) {
                    n = b;
                    k = e;
                    f = 0.5;
                    m = (h - k) / a / 3;
                    for (var q = 0; q < m; q++) this.ctx.bezierCurveTo(n + f * a, k + a, n + f * a, k + 2 * a, n, k + 3 * a), k += 3 * a, f *= -1;
                    this.ctx.bezierCurveTo(n + f * a,
                        k + a, n + f * a, k + 2 * a, n, k + 3 * a);
                    n = l;
                    f *= -1;
                    this.ctx.lineTo(n, k);
                    for (q = 0; q < m; q++) this.ctx.bezierCurveTo(n + f * a, k - a, n + f * a, k - 2 * a, n, k - 3 * a), k -= 3 * a, f *= -1
                } else {
                    if ("zigzag" === this.type) {
                        f = -1;
                        k = e + a;
                        n = b + a;
                        m = (h - k) / a / 2;
                        for (q = 0; q < m; q++) this.ctx.lineTo(n, k), n += 2 * f * a, k += 2 * a, f *= -1;
                        this.ctx.lineTo(n, k);
                        n += l - b;
                        for (q = 0; q < m + 1; q++) this.ctx.lineTo(n, k), n += 2 * f * a, k -= 2 * a, f *= -1;
                    ...
                    if (e = 1 === p % 2 ? (e.y << 0) + 0.5 : e.y <<
                        0, h = 1 === p % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, l = this.chart.plotArea.x2 + p / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, l = this.chart.plotArea.x1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = {
                            x1: b,
                            y1: e - p / 2,
                            x2: l,
                            y2: h + p / 2
                        }, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(l, e), this.ctx.lineTo(l, h), this.ctx.lineTo(b, h);
                    else if ("wavy" === this.type) {
                    n = b;
                    k = e;
                    f = 0.5;
                    m =
                        (l - n) / a / 3;
                    for (q = 0; q < m; q++) this.ctx.bezierCurveTo(n + a, k + f * a, n + 2 * a, k + f * a, n + 3 * a, k), n += 3 * a, f *= -1;
                    this.ctx.bezierCurveTo(n + a, k + f * a, n + 2 * a, k + f * a, n + 3 * a, k);
                    k = h;
                    f *= -1;
                    this.ctx.lineTo(n, k);
                    for (q = 0; q < m; q++) this.ctx.bezierCurveTo(n - a, k + f * a, n - 2 * a, k + f * a, n - 3 * a, k), n -= 3 * a, f *= -1
                    ...
                    n = b + a;
                    m = (l - n) / a / 2;
                    for (q = 0; q < m; q++) this.ctx.lineTo(n, k), k += 2 * f * a, n += 2 * a, f *= -1;
                    this.ctx.lineTo(n, k);
                    k += h - e;
                    for (q = 0; q < m + 1; q++) this.ctx.lineTo(n, k), k += 2 * f * a, n -= 2 * a, f *= -1;
        ...
        N.prototype.render = function() {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, h = this.chart.plotArea.y1, n = this.chart.plotArea.y2, this.bounds = {
                    x1: e - d / 2,
                    y1: h,
                    x2: f + d / 2,
                    y2: n
                };
                else if ("left" === this.parent._position || "right" === this.parent._position) h = n = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, f = this.chart.plotArea.x2, this.bounds = {
                    x1: e,
                    y1: h - d / 2,
                    x2: f,
                    y2: n + d / 2
        ...
        ca.prototype.render = function(a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    for (var B = 0; B < this.parent.dataSeries.length; B++)(v = this.parent.dataSeries[B].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[B], null !== v.dataPoint.y && v.dataSeries.visible &&
                        m.push(v));
                    v = null;
                    ...
                    if ("rangeBar" === m[0].dataSeries.type || "error" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[B].dataPoint.y[0])), u = 0, r = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (var y = 0; y < m[r].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), u < v && (v = u, B = r);
                            else u =
                                Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y)), u < v && (v = u, B = r);
                    else if ("stackedBar" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), x = u = 0, r = B = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), u < v && (v = u, B = r);
                            else x += m[r].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(x)), u < v && (v = u, B = r);
                    else if ("stackedBar100" === m[0].dataSeries.type)
                        for (var v =
                                Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), z = x = u = 0, r = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), u < v && (v = u, B = r);
                            else x += m[r].dataPoint.y, z = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, z = 100 * (x / m[r].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(a - this.parent.convertValueToPixel(z)), u < v && (v = u, B = r);
                    else
                        for (v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)),
                            r = B = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), u < v && (v = u, B = r);
                            else u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y)), u < v && (v = u, B = r);
                    y = m[B];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type) {
                            ...
                            for (r = u = 0; r < y.dataPoint.y.length; r++) u = Math.abs(a - this.parent.convertValueToPixel(y.dataPoint.y[r])), u < v && (v = u, b = r);
                            n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.y[b]) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.y[b]) << 0;
                            ...
                            k.text = this.labelFormatter ? this.labelFormatter({
                                ...
                                }) : s(this.options.label) ? da(s(c) ? y.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo) :
                                this.label
                        } else if ("stackedBar" === this.parent.dataSeries[B].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            x = u = 0;
                            for (r = B; 0 <= r; r--) x += m[r].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(x)), u < v && (v = u, b = r);
                            n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x) << 0) + 0.5 : this.parent.convertValueToPixel(x) << 0;
                            this.value = x;
                            k.text = this.labelFormatter ? this.labelFormatter({
                                    chart: this.chart,
                                    axis: this.parent.options,
                                ...
                                da(s(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else if ("stackedBar100" === this.parent.dataSeries[B].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            z = x = u = 0;
                            for (r = B; 0 <= r; r--) x += m[r].dataPoint.y, z = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, z = 100 * (x / m[r].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(a - this.parent.convertValueToPixel(z)), u < v && (v = u, b = r);
                            n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(z) << 0) + 0.5 :
                            ...
                            k.text = this.labelFormatter ? this.labelFormatter({
                                ...
                                crosshair: this.options,
                                value: z
                            }) : s(this.options.label) ? da(s(c) ? z : c, this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.y) << 0, this.value = y.dataPoint.y, k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: y.dataPoint.y
                        ...
                        if (this.parent.labels)
                            for (m = Math.ceil(this.parent.interval), r = 0; r < this.parent.viewportMaximum; r +=
                                m)
                            ...
                            if ("axisX" === this.parent.type)
                                for (r = this.parent.convertPixelToValue({
                                        y: d
                                    }), v = null, B = 0; B < this.parent.dataSeries.length; B++)(v = this.parent.dataSeries[B].getDataPointAtX(r, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({
                                    chart: this.chart,
                                    axis: this.parent.options,
                                    crosshair: this.options,
                                    value: y.dataPoint.x
                            ...
                            this.labelFormatter ? this.labelFormatter({
                                ...
                                crosshair: this.options,
                                value: y.dataPoint.x
                            }) : s(this.options.label) ? da(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: y.dataPoint.x
                            }) : s(this.options.label) ? Ba(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label;
                    ...
                    for (B = 0; B < this.parent.dataSeries.length; B++)(v =
                        this.parent.dataSeries[B].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[B], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    if (0 === m.length) return;
                    m.sort(function(a, b) {
                        return a.distance - b.distance
                    });
                    y = m[0];
                    b = e = n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.x) << 0;
                    f = this.chart.plotArea.y1;
                    h = this.chart.plotArea.y2;
                    this.bounds = {
                        x1: b - p / 2,
                    ...
                    z = !1;
                    if (this.parent.labels)
                        for (m = Math.ceil(this.parent.interval),
                            r = 0; r < this.parent.viewportMaximum; r += m)
                            if (this.parent.labels[r]) z = !0;
                            else {
                                z = !1;
                                break
                    ...
                    for (B = 0; B < this.parent.dataSeries.length; B++)(v = this.parent.dataSeries[B].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[B], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    if (0 === m.length) return;
                    m.sort(function(a, b) {
                        return a.distance - b.distance
                    });
                    B = 0;
                    if ("rangeColumn" === m[0].dataSeries.type || "rangeArea" === m[0].dataSeries.type || "error" === m[0].dataSeries.type || "rangeSplineArea" === m[0].dataSeries.type || "candlestick" === m[0].dataSeries.type || "ohlc" === m[0].dataSeries.type ||
                        "boxAndWhisker" === m[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y[0])), r = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), u < v && (v = u, B = r);
                            else u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y)), u < v && (v = u, B = r);
                    else if ("stackedColumn" === m[0].dataSeries.type || "stackedArea" === m[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)),
                            r = x = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), u < v && (v = u, B = r);
                            else x += m[r].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(x)), u < v && (v = u, B = r);
                    else if ("stackedColumn100" === m[0].dataSeries.type || "stackedArea100" === m[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = z = x = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y =
                                    0; y < m[r].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), u < v && (v = u, B = r);
                            else x += m[r].dataPoint.y, z = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, z = 100 * (x / m[r].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(d - this.parent.convertValueToPixel(z)), u < v && (v = u, B = r);
                    else
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) u =
                                    Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), u < v && (v = u, B = r);
                            else u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y)), u < v && (v = u, B = r);
                    y = m[B];
                    b = 0;
                    if ("rangeColumn" === this.parent.dataSeries[B].type || "rangeArea" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type || "rangeSplineArea" === this.parent.dataSeries[B].type || "candlestick" === this.parent.dataSeries[B].type || "ohlc" === this.parent.dataSeries[B].type || "boxAndWhisker" === this.parent.dataSeries[B].type) {
                        ...
                        for (r = u = 0; r < y.dataPoint.y.length; r++) u = Math.abs(d - this.parent.convertValueToPixel(y.dataPoint.y[r])), u < v && (v = u, b = r);
                        ...
                        k.text = this.labelFormatter ? this.labelFormatter({
                            ...
                            crosshair: this.options,
                            value: y.dataPoint.y[b]
                        }) : s(this.options.label) ? da(s(c) ? y.dataPoint.y[b] : c, this.valueFormatString,
                        ...
                        x = u = 0;
                        for (r = B; 0 <= r; r--) x += m[r].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(x)), u < v && (v = u, b = r);
                        ...
                        v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y));
                        x = u = 0;
                        for (r = B; 0 <= r; r--) x += m[r].dataPoint.y, z = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, z = 100 * (x / m[r].dataSeries.plotUnit.dataPointYSums[z]),
                            u = Math.abs(d - this.parent.convertValueToPixel(z)), u < v && (v = u, b = r);
                        ...
                        0) + 0.5 : this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum) << 0, k.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: y.dataSeries.dataPointEOs[y.index].cumulativeSum
                    }) : s(this.options.label) ? da(s(c) ? y.dataSeries.dataPointEOs[y.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = y.dataSeries.dataPointEOs[y.index].cumulativeSum) : (w = 1 === q.lineWidth % 2 ? (s(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) <<
                        0) + 0.5 : s(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0, k.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: s(c) ? y.dataPoint.y : c
                    }) : s(this.options.label) ? da(s(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = y.dataPoint.y);
                    f = h = w;
                    b = this.chart.plotArea.x1;
                    e = this.chart.plotArea.x2;
                    this.bounds = {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = n = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, h = this.chart.plotArea.y2, this.bounds = {
                    x1: b - p / 2,
                    y1: f,
                    x2: e + p / 2,
                    y2: h
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" ===
                        ...
                        }) : s(this.options.label) ? da(s(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: s(c) ? this.parent.convertPixelToValue(d) : c
                    ...
                    if (this.parent.labels)
                        ...
                        if ("axisX" === this.parent.type)
                            for (r = this.parent.convertPixelToValue({
                                ...
                                crosshair: this.options,
                                value: s(c) ? this.parent.convertPixelToValue(a) : c
                            }) : s(this.options.label) ? s(c) ? v.dataPoint.label : c : this.label)
                    } else k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ?
                        this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                        ...
                        }) : s(this.options.label) ? da(s(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: s(c) ? this.parent.convertPixelToValue(a) : c
                        }) : s(this.options.label) ? Ba(s(c) ?
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position) this._updatedValue = this.parent.convertPixelToValue(n);
            if ("left" === this.parent._position ||
        ...
        ca.prototype.renderLabel = function() {
            ...
            s(this._label) && this.dispatchEvent("updated", {
                chart: this.chart,
                crosshair: this.options,
                axis: this.parent,
                value: this.value
        ...
        U.prototype.mouseMoveHandler = function(a, d) {
            this._lastUpdated && 4 > (new Date).getTime() - this._lastUpdated || (this._lastUpdated = (new Date).getTime(), this.chart.resetOverlayedCanvas(), this._updateToolTip(a, d), !this._updatedEventParameters || (isNaN(this._prevX) || isNaN(this._prevY)) || this.dispatchEvent("updated", this._updatedEventParameters, this))
        };
        U.prototype._updateToolTip = function(a, d, c) {
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    ...
                    if (this.chart.axisX)
                        for (var v = 0; v < this.chart.axisX.length; v++) {
                            for (var h = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX[v].convertPixelToValue({
                                    ...
                                    x: a
                                }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)(k =
                                this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && n.push(k));
                            k = null
                        }
                    if (this.chart.axisX2)
                        for (v = 0; v < this.chart.axisX2.length; v++) {
                            h = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX2[v].convertPixelToValue({
                                y: d
                            }) : this.chart.axisX2[v].convertPixelToValue({
                                x: a
                            });
                            k = null;
                            for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)(k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h,
                                c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && n.push(k));
                            k = null
                        }
                    ...
                    c = n[0];
                    for (b = 0; b < n.length; b++) n[b].dataPoint.x.valueOf() === c.dataPoint.x.valueOf() && f.push(n[b]);
                    n = null
                } else {
                    if (b = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = b.dataPointIndex, this.currentSeriesIndex = b.dataSeries.index;
                        ...
                        if (b = $a(a, d, this.chart._eventManager.ghostCtx), 0 < b &&
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        k = {};
                        if (0 <= this.currentDataPointIndex) b = e.dataPoints[this.currentDataPointIndex], k.dataSeries = e, k.dataPoint = b,
                            k.index = this.currentDataPointIndex, k.distance = Math.abs(b.x - h), "waterfall" === e.type && (k.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue, k.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum);
                        else {
                            if (!this.enabled || "line" !== e.type && "stepLine" !== e.type && "spline" !== e.type && "area" !== e.type && "stepArea" !== e.type && "splineArea" !== e.type && "stackedArea" !== e.type && "stackedArea100" !== e.type && "rangeArea" !== e.type && "rangeSplineArea" !== e.type && "candlestick" !==
                                e.type && "ohlc" !== e.type && "boxAndWhisker" !== e.type) return;
                ...
                if (0 < f.length) {
                    if (this.highlightObjects(f), this.enabled) {
                        ...
                        if (null !== c) {
                            ...
                            try {
                                this.contentDiv.style.background = this.backgroundColor ? this.backgroundColor : w ? "rgba(255,255,255,.9)" : "rgb(255,255,255)", this.borderColor = "waterfall" === f[0].dataSeries.type ?
                            ...
                            d = 1 !== f.length || this.shared || "line" !== f[0].dataSeries.type && "stepLine" !== f[0].dataSeries.type && "spline" !== f[0].dataSeries.type && "area" !== f[0].dataSeries.type && "stepArea" !== f[0].dataSeries.type && "splineArea" !== f[0].dataSeries.type ? "bar" === f[0].dataSeries.type || "rangeBar" === f[0].dataSeries.type || "stackedBar" ===
                                f[0].dataSeries.type || "stackedBar100" === f[0].dataSeries.type ? f[0].dataSeries.axisX.convertValueToPixel(f[0].dataPoint.x) : d : f[0].dataSeries.axisY.convertValueToPixel(f[0].dataPoint.y);
                            d = -d + 10;
            ...
            for (var h = 0; h < a.length; h++)
                ...
                for (var n = null, s = "", h = 0; h < a.length; h++) {
                    ...
                    if (0 === h && this.isToolTipDefinedInData && !this.content) {
                        this.chart.axisX && 0 < this.chart.axisX.length ? s += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ? this.chart.axisX[0].labels[b.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length && (s += "undefined" !== typeof this.chart.axisX2[0].labels[b.x] ? this.chart.axisX2[0].labels[b.x] : "{x}");
                        s += "</br>";
                    ...
                    null === b.toolTipContent || "undefined" === typeof b.toolTipContent && null === c.options.toolTipContent || ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" === c.type || "scatter" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "stackedBar" === c.type || "stackedBar100" === c.type || "stackedArea" === c.type || "stackedArea100" === c.type || "waterfall" ===
                        c.type ? (this.chart.axisX && 1 < this.chart.axisX.length && (f += n != c.axisXIndex ? c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""), f += b.toolTipContent ? b.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span data-color='\"" + (this.options.fontColor ? "" : "'{color}'") + "\"'>{name}:</span>&nbsp;&nbsp;{y}", n = c.axisXIndex) : "bubble" === c.type ? (this.chart.axisX && 1 < this.chart.axisX.length && (f += n != c.axisXIndex ? c.axisX.title ? c.axisX.title + "<br/>" :
                            ...
                            b, c, e) + d, h < a.length - 1 && (d = "</br>" + d)) : (d += this.chart.replaceKeywordsWithValue(f, b, c, e), h < a.length - 1 && (d += "</br>"))))
                }
                null !== d && (d = s + d)
            } else {
                c = a[0].dataSeries;
                ...
                "line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" === c.type || "scatter" === c.type || "stackedColumn" === c.type || "stackedColumn100" ===
                    ...
                    this.content && "function" !== typeof this.content ? this.content : "<span data-color='\"" + (this.options.fontColor ? "" : "'{color}'") + "\"'>" + (b.label ? "{label}" : "{x}") + "</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low: &nbsp;&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}" : "boxAndWhisker" === c.type && (f = b.toolTipContent ? b.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span data-color='\"" + (this.options.fontColor ?
                        "" : "'{color}'") + "\"'>" + (b.label ? "{label}" : "{x}") + "</span><br/>Minimum: &nbsp;{y[0]}<br/>Q1:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{y[1]}<br/>Q2:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{y[4]}<br/>Q3:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{y[2]}<br/>Maximum: &nbsp;{y[3]}");
                null === d && (d = "");
        ...
        U.prototype.hide = function(a) {
            this.container &&
                (this.container.style.display = "none", this.currentSeriesIndex = -1, this._prevY = this._prevX = NaN, ("undefined" === typeof a || a) && this.chart.resetOverlayedCanvas())
        };
        ...
        U.prototype.showAtX = function(a, d) {
            ...
            if (this.shared)
                for (var h = 0; h < this.chart.data.length; h++) c =
                    this.chart.data[h], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !s(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b));
            else c = this.chart.data[d], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !s(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b));
            if (0 < f.length) {
                for (h = 0; h < f.length; h++)
                    if (b = f[h], (this.shared || 0 <= b.dataSeries.type.indexOf("100")) && b.dataPoint.x >= b.dataSeries.axisX.viewportMinimum && b.dataPoint.x <= b.dataSeries.axisX.viewportMaximum) {
                        e = !1;
                        break
                    } else if (b.dataPoint.x < b.dataSeries.axisX.viewportMinimum ||
        ...
        ia.prototype.animate = function(a, d, c, b, e) {
            ...
            0 < this.animations.length ? this.animationRequestId =
                this.chart.requestAnimFrame.call(window, function() {
                    f.animate.call(f)
